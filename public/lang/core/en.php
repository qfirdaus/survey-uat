...
'profile_login_activity_heading'=> 'Session Security',
'profile_login_activity_intro'  => 'Review access history and devices used, and terminate active sessions you no longer recognize.',
'profile_audit_heading'         => 'Account Activity Records',
'profile_audit_intro'           => 'Review important activity recorded for this account and the outcome of each action.',

// Language preference alerts
'profile_alert_security_title'  => 'Security Error',
'profile_alert_security_text'   => 'The security token is invalid. Refresh the page and try again.',
'profile_alert_access_title'    => 'Access Denied',
'profile_alert_access_text'     => 'The user session is invalid. Please log in again.',
'profile_alert_validation_title'=> 'Validation Error',
'profile_alert_validation_text' => 'Please select a valid active language.',
'profile_alert_save_title'      => 'Save Error',
'profile_alert_save_text'       => 'No changes were saved or the update could not be processed.',
'profile_alert_system_title'    => 'System Error',
'profile_alert_system_text'     => 'An error occurred while saving your language preference.',
...
'developerGuide_copy_code'       => 'Copy code sample',
'developerGuide_copy_path'       => 'Copy document path',
'developerGuide_kpi_topics'      => 'Guide topics',
'developerGuide_kpi_samples'     => 'Code samples',
'developerGuide_kpi_references'  => 'References',
'developerGuide_current_title'   => 'Framework aligned',
'developerGuide_current_text'    => 'Samples follow current security and audit patterns.',
'developerGuide_search_label'    => 'Search this guide',
'developerGuide_search_placeholder' => 'Search topics, rules or samples...',
'developerGuide_clear_search'    => 'Clear search',
'developerGuide_search_result'   => '%d topics match your search',
'developerGuide_search_no_result'=> 'No topics match your search.',
'developerGuide_ui_rules'        => 'Rules',
'developerGuide_ui_references'   => 'References',
'developerGuide_ui_core_boundary'=> 'Core Boundary',
'developerGuide_ui_page_file'    => 'Page File',
'developerGuide_ui_controller'   => 'Controller',
'developerGuide_ui_separation'   => 'Separation',
'developerGuide_ui_sample'       => 'Sample',
'developerGuide_ui_main_mysql'   => 'Main MySQL',
'developerGuide_ui_additional_db'=> 'Additional DB',
'developerGuide_ui_transaction'  => 'Transaction',
'developerGuide_ui_endpoint'     => 'Endpoint',
'developerGuide_ui_external_service' => 'External Service',
'developerGuide_ui_event'        => 'Event',
'developerGuide_ui_workflow'     => 'Workflow',
'developerGuide_ui_admin_samples'=> 'Admin Samples',
'developerGuide_ui_custom_keys'  => 'Custom Keys',
'developerGuide_ui_setup_flow'   => 'Setup Flow',
'developerGuide_ui_reference'    => 'Reference',
'developerGuide_ui_audit_event'  => 'Audit Event',
'developerGuide_ui_view_as'      => 'View As',
'developerGuide_ui_template'     => 'Template',
'developerGuide_ui_components'   => 'Components',
'developerGuide_ui_boundary'     => 'Boundary',
'developerGuide_ui_before_coding'=> 'Before Coding',
'developerGuide_ui_before_handover' => 'Before Handover',
'developerGuide_rule_do_title'   => 'Do',
'developerGuide_rule_do_text'    => 'Use services, controllers, AJAX helpers, custom language files, and UI-managed menu/access setup.',
'developerGuide_rule_dont_title' => 'Do Not',
'developerGuide_rule_dont_text'  => 'Do not edit sidebar, topbar, init, Database core, Notification core, Audit core, or core language files for project needs.',
'developerGuide_rule_register_title' => 'Register',
'developerGuide_rule_register_text' => 'After creating a page, register module/menu/subgroup and group access from User Groups, not from source code.',
'developerGuide_recommended_flow'=> 'Recommended flow: generate or create page files, add controller/service/AJAX, add language keys in custom files, register menu/access in UI, then test authorization and audit behavior.',
...
'profile_login_kill_error_no_session'
                                => 'Invalid session ID',
'profile_session_rate_limit'    => 'Too many attempts. Please wait a moment.',
'profile_session_method_invalid'=> 'Request method not allowed.',
'profile_session_json_invalid'  => 'Invalid JSON input.',
'profile_session_id_required'   => 'Session ID was not provided.',
'profile_session_current_denied'=> 'The current session cannot be terminated.',
'profile_session_login_required'=> 'Please log in first.',
'profile_session_user_not_found'=> 'User not found.',
'profile_session_not_owned'     => 'The session was not found or does not belong to you.',
'profile_session_already_ended' => 'This session has already ended.',
'profile_session_terminate_success' => 'Session terminated successfully.',
'profile_session_terminate_failed'  => 'Failed to terminate the session. It may have already ended.',
'profile_session_database_error'    => 'Database error. Please try again.',
'profile_session_system_error'      => 'System error. Please try again.',
...
'profile_audit_stat_meta'       => 'Meta',
'profile_audit_stat_sets'       => 'Sets',
'profile_audit_stat_changes'    => 'Diff',
'profile_audit_outcome_success' => 'Success',
'profile_audit_outcome_failure' => 'Failed',
'profile_audit_outcome_unknown' => 'Unknown',
'profile_audit_severity_security' => 'Security',
'profile_audit_severity_warning'  => 'Warning',
'profile_audit_severity_info'     => 'Information',
'profile_audit_severity_unknown'  => 'Unknown',
'profile_audit_event_create'    => 'Create',
'profile_audit_event_update'    => 'Update',
'profile_audit_event_delete'    => 'Delete',
'profile_audit_event_login'     => 'Login',
'profile_audit_event_logout'    => 'Logout',
'profile_audit_event_view'      => 'View',
'profile_audit_field_generic'   => 'Field',
'profile_audit_change_generic'  => 'Change',
'profile_audit_value_recorded'  => 'Recorded',
'profile_audit_value_updated'   => 'Updated',
'profile_audit_change_recorded' => 'Change recorded',
'profile_audit_value_hidden'    => 'Hidden',
'profile_audit_invalid_event_id'=> 'Invalid audit event ID.',
'profile_audit_event_not_found' => 'Audit event not found.',
'profile_audit_server_error'    => 'Server error while retrieving audit information.',
...
'userList_page_intro'            => 'Manage user identities, groups, access levels and additional roles by account category.',
...
'userList_ajax_method_not_allowed' => 'Request method not allowed.',
'userList_validation_required_public' => 'Complete all required information and ensure the email address and passwords are valid.',
'userList_validation_required_access' => 'Complete the user information and access settings before saving.',
'userList_ajax_staff_scope_only' => 'This add-user flow is for staff only.',
'userList_ajax_student_scope_only' => 'This add-user flow is for students only.',
'userList_ajax_public_scope_only' => 'This add-user flow is for public users only.',
'userList_ajax_employee_no_required' => 'Employee number cannot be empty.',
'userList_ajax_matric_required' => 'Matric number cannot be empty.',
'userList_ajax_invalid_staff_group' => 'The selected group is not valid for staff access.',
'userList_ajax_invalid_student_group' => 'The selected group is not valid for student access.',
'userList_ajax_employee_exists' => 'A user with this employee number already exists.',
'userList_ajax_student_exists' => 'A student with this matric number already exists.',
'userList_ajax_staff_source_not_found' => 'The staff member was not found in the data source or is inactive.',
'userList_ajax_student_source_not_found' => 'The student was not found in the data source or is inactive.',
'userList_ajax_invalid_matric' => 'Invalid matric number.',
'userList_ajax_student_not_found' => 'Student not found.',
'userList_ajax_load_staff_error' => 'A system error occurred while loading the staff list.',
'userList_ajax_search_staff_error' => 'A system error occurred while searching for staff.',
'userList_ajax_success_add_public' => 'Public user added successfully.',
'userList_ajax_database_error' => 'A database error occurred while processing the user.',
'userList_ajax_add_system_error' => 'A system error occurred while adding the user.',
'userList_ajax_add_student_system_error' => 'A system error occurred while adding the student.',
'userList_ajax_add_public_system_error' => 'A system error occurred while adding the public user.',
...
'userList_ajax_group_assign_denied' => 'You are not allowed to assign users to this group.',
'userList_ajax_user_edit_denied' => 'You are not allowed to update this user.',
...
'userGroup_done'                    => 'Success',
'userGroup_group_create_success'    => 'Group added successfully.',
'userGroup_group_update_success'    => 'Group updated successfully.',
'userGroup_loading_access'          => 'Loading access...',
'userGroup_loading_menu'            => 'Loading menu...',
'userGroup_color_picker_title'      => 'Choose group colour',
...
// Professional Access Matrix workspace
'access_matrix_title' => 'Access Matrix',
'access_matrix_breadcrumb_home' => 'Dashboard',
'access_matrix_eyebrow' => 'Super Admin Access Review',
'access_matrix_hero_title' => 'Understand access across every system menu',
'access_matrix_hero_text' => 'Review the complete menu catalogue and compare group permissions from one controlled workspace.',
'access_matrix_readonly_title' => 'Read-only view',
'access_matrix_readonly_text' => 'Access changes are managed from User Groups.',
'access_matrix_summary_label' => 'Access summary',
'access_matrix_kpi_groups' => 'User groups',
'access_matrix_kpi_modules' => 'Modules',
'access_matrix_kpi_menus' => 'System menus',
'access_matrix_kpi_permissions' => 'Access mappings',
'access_matrix_workspace_eyebrow' => 'Permission Explorer',
'access_matrix_workspace_title' => 'System Access Matrix',
'access_matrix_workspace_text' => 'Search and filter locally without reloading the page.',
'access_matrix_legend' => 'Legend',
'access_matrix_has_access' => 'Has access',
'access_matrix_no_access' => 'No access',
'access_matrix_search_label' => 'Search menu or path',
'access_matrix_search_placeholder' => 'Type a menu name or path...',
'access_matrix_module_filter' => 'Module',
'access_matrix_all_modules' => 'All modules',
'access_matrix_group_filter' => 'User group',
'access_matrix_all_groups' => 'All groups',
'access_matrix_status_filter' => 'Access status',
'access_matrix_all_statuses' => 'All statuses',
'access_matrix_reset' => 'Reset',
'access_matrix_result_count' => '%d menus displayed',
'access_matrix_scroll_hint' => 'Scroll horizontally to compare groups',
'access_matrix_error_title' => 'Unable to load access matrix',
'access_matrix_error_text' => 'Please refresh the page or try again later.',
'access_matrix_empty_title' => 'No access data available',
'access_matrix_empty_text' => 'No modules, menus or user groups are currently available.',
'access_matrix_table_label' => 'System access matrix table',
'access_matrix_menu_column' => 'Menu',
'access_matrix_path_column' => 'Path',
'access_matrix_module_menu_count' => '%d menus',
'access_matrix_filter_empty_title' => 'No matching menus',
'access_matrix_filter_empty_text' => 'Adjust or reset the current filters.',
...
'manual_table_unavailable' => 'The user manual database table is unavailable. Run the approved deployment migration.',
'manual_sync_retired' => 'Group synchronization is no longer required. All groups are displayed automatically.',
'manual_view_invalid_request' => 'Invalid manual request.',
'manual_view_load_failed' => 'Unable to load the manual.',
'manual_hero_eyebrow' => 'Controlled Documentation',
'manual_hero_title' => 'Keep every user group supported with the right guide',
'manual_hero_text' => 'Upload, replace and review group-specific PDF manuals through one secure management workspace.',
'manual_secure_title' => 'Protected PDF workflow',
'manual_secure_text' => 'PDF validation is enforced with a maximum file size of %dMB.',
'manual_summary_label' => 'Manual coverage summary',
'manual_kpi_groups' => 'User groups',
'manual_kpi_available' => 'Manuals available',
'manual_kpi_missing' => 'Manuals missing',
'manual_kpi_coverage' => 'Coverage',
'manual_list_eyebrow' => 'Manual Library',
'manual_list_title' => 'Group Manual Coverage',
'manual_list_text' => 'Review availability and manage the current PDF for each user group.',
...
'pageTemplateGenerator_error_permission' => 'Only Super Admin can access the system template generator.',
'pageTemplateGenerator_error_bootstrap' => 'The template generator could not be loaded. Please contact the system administrator.',
'pageTemplateGenerator_error_invalid_action' => 'The requested generator action is invalid.',
'pageTemplateGenerator_error_slug_exists' => 'A template record already exists for this page slug.',
'pageTemplateGenerator_error_controller_exists' => 'A template record already exists for this controller class.',
'pageTemplateGenerator_validation_too_long' => 'This value exceeds the permitted length.',
'pageTemplateGenerator_validation_icon' => 'Please select a valid page icon.',
'pageTemplateGenerator_eyebrow' => 'Developer Workspace',
'pageTemplateGenerator_hero_title' => 'Build governed pages with confidence',
'pageTemplateGenerator_hero_subtitle' => 'Create consistent page foundations, validate every output, and retain a clear generation record.',
'pageTemplateGenerator_summary_label' => 'Template summary',
'pageTemplateGenerator_metric_total' => 'Total templates',
'pageTemplateGenerator_metric_generated' => 'Ready',
'pageTemplateGenerator_metric_archived' => 'Archived',
'pageTemplateGenerator_super_admin_note' => 'Super Admin controlled',
'pageTemplateGenerator_step_identity' => 'Page information',
'pageTemplateGenerator_step_branding' => 'Icon selection',
'pageTemplateGenerator_step_access' => 'Access policy',
'pageTemplateGenerator_detail_overview' => 'Generated asset',
'pageTemplateGenerator_detail_created_by' => 'Generated by',
'pageTemplateGenerator_detail_outputs' => 'Output files',
'pageTemplateGenerator_btn_copy' => 'Copy path',
'pageTemplateGenerator_copy_success' => 'Path copied',
'pageTemplateGenerator_copy_failed' => 'Unable to copy path',
...
'notification_hero_eyebrow' => 'PERSONAL NOTIFICATION CENTRE',
'notification_hero_title' => 'Stay informed and act with confidence',
'notification_hero_text' => 'Review system updates, announcements and tasks assigned to your account in one organised workspace.',
'notification_private_title' => 'Private to your account',
'notification_private_text' => 'Only notifications visible to your active identity and access group are shown.',
'notification_summary_label' => 'Notification summary',
'notification_kpi_total' => 'Total',
'notification_kpi_unread' => 'Unread',
'notification_kpi_action' => 'Action required',
'notification_kpi_overdue' => 'Overdue',
'notification_workspace_eyebrow' => 'YOUR INBOX',
'notification_workspace_title' => 'Notification workspace',
'notification_workspace_text' => 'Filter, search and review messages without leaving this page.',
'notification_filter_label' => 'Notification filters',
'notification_search_label' => 'Search notifications',
'notification_search_placeholder' => 'Search title or message...',
'notification_loading_local' => 'Loading notifications...',
'notification_empty_title' => 'Your inbox is clear',
'notification_empty_text' => 'No notifications match the current filter or search.',
'notification_error_title' => 'Notifications could not be loaded',
'notification_retry' => 'Try again',
'notification_open' => 'Open',
'notification_mark_read' => 'Mark as read',
'notification_read_all_busy' => 'Updating...',
'notification_page_label' => 'Page {page} of {pages}',
'notification_results_label' => 'Showing {start}–{end} of {total} notifications',
'notification_pagination_label' => 'Notification pages',
'notification_previous' => 'Previous',
'notification_next' => 'Next',
'notification_rate_limited' => 'Too many requests. Please try again shortly.',
'notification_admin_page_title' => 'Notification Admin',
'notification_admin_hero_eyebrow' => 'CONTROLLED COMMUNICATION',
'notification_admin_hero_title' => 'Publish the right message to the right audience',
'notification_admin_hero_text' => 'Create, target and review system notifications from one governed administration workspace.',
'notification_admin_hero_note_title' => 'Publication affects real users',
'notification_admin_hero_note_text' => 'Review the audience and preview before confirming a publication.',
'notification_admin_summary_label' => 'Notification publication summary',
'notification_admin_target_count' => 'Target count',
'notification_admin_no_audience' => 'No audience',
'notification_admin_more' => 'more',
'notification_admin_rules' => 'rules',
'notification_admin_status' => 'Status',
'notification_admin_inactive' => 'Inactive',
'notification_admin_filter_label' => 'Notification filters',
'notification_admin_list_failed' => 'Unable to load notification records.',
'notification_admin_tab_setup' => 'Setup Notification',
'notification_admin_tab_basic' => 'Basic',
'notification_admin_tab_content' => 'Content',
'notification_admin_tab_audience' => 'Audience',
'notification_admin_tab_action' => 'Action & Schedule',
'notification_admin_audience_all_users' => 'All users',
'notification_admin_confirm_title_label' => 'Title',
'notification_admin_confirm_audience_label' => 'Audience',
'notification_admin_confirm_type_label' => 'Type / Priority',
'notification_admin_confirm_schedule_label' => 'Expiry',
'notification_admin_no_expiry' => 'No expiry',
'notification_admin_confirm_title' => 'Confirm notification publication',
'notification_admin_confirm_text' => 'Review the publication details before continuing.',
'notification_admin_confirm_broadcast_title' => 'Confirm broadcast to all users',
'notification_admin_confirm_broadcast_text' => 'This notification will be visible to every eligible user.',
'notification_admin_confirm_publish' => 'Yes, publish',
'notification_admin_validation_title' => 'A notification title is required.',
'notification_admin_validation_title_length' => 'Title must not exceed 255 characters.',
'notification_admin_validation_body_length' => 'Notification content must not exceed 10,000 characters.',
'notification_admin_validation_audience' => 'A valid audience is required.',
'notification_admin_validation_datetime' => 'One or more date values are invalid.',
'notification_admin_validation_schedule' => 'Expiry must be later than the start date.',
'notification_admin_validation_due_action' => 'Enable user action when a due date is supplied.',
'notification_admin_validation_due_expiry' => 'Due date cannot be later than expiry.',
'notification_admin_validation_audience_limit' => 'Audience is limited to 500 values per publication.',
'notification_admin_validation_audience_value' => 'An audience value is too long.',
'notification_admin_validation_action_url' => 'Action URL must be a safe internal application path.',
'notification_admin_example_prefix' => 'Example:',
'notification_admin_copied' => 'Copied',
'notification_admin_copy' => 'Copy',
'notification_admin_sample' => 'Sample',
'common_dashboard' => 'Dashboard',
'notification_admin_samples_button' => 'Developer Samples',
'notification_admin_samples_title' => 'Notification Developer Samples',
'notification_admin_samples_subtitle' => 'Copy standard workflow notification snippets for module integration.',
'notification_admin_help_event_code' => 'Internal reference code for tracking. The system generates one when left blank.',
'notification_admin_help_template' => 'Select a template to populate content, icon and basic settings automatically.',
'notification_admin_help_type' => 'Choose the notification function: announcement, reminder, event or workflow task.',
'notification_admin_help_severity' => 'Controls the visual emphasis and urgency shown to users.',
'notification_admin_help_priority' => 'Priority is used for ordering and emphasis.',
'notification_admin_help_dedupe_key' => 'Use a unique key when the same notification should not be duplicated.',
'notification_admin_help_dedupe_behavior' => 'Update changes the existing record, skip ignores duplicates, and republish creates a new record.',
'notification_admin_help_title_ms' => 'Primary Malay title displayed to users. This field is required.',
'notification_admin_help_title_en' => 'English title. The Malay title is used as fallback when empty.',
'notification_admin_help_body_ms' => 'Write a short, clear Malay message suitable for the notification panel.',
'notification_admin_help_body_en' => 'Provide the English message when the system is used in English mode.',
'notification_admin_help_audience_type' => 'Choose who receives the notification. Use ALL for every eligible user.',
'notification_admin_help_group_picker' => 'Quickly select a group and populate its group ID.',
'notification_admin_help_category_picker' => 'Quickly target a user category such as STAF, PELAJAR or UMUM.',
'notification_admin_help_action_url' => 'Use an internal application path only, for example pages/profile.php.',
'notification_admin_help_action_label_ms' => 'Malay action-button text, for example Semak Sekarang.',
'notification_admin_help_action_label_en' => 'English action-button text, for example Review Now.',
'notification_admin_help_due_at' => 'Deadline for user action. Leave blank when there is no deadline.',
'notification_admin_help_expires_at' => 'Date and time when the notification stops being displayed.',
'notification_admin_help_icon' => 'Select an icon that reflects the message type.',
'notification_admin_help_requires_action' => 'Enable when the user must complete or acknowledge a task.',
'common_yes' => 'Yes',
'common_no' => 'No',
...
'notification_template_hero_eyebrow' => 'REUSABLE COMMUNICATION',
'notification_template_hero_title' => 'Build consistent notifications once, reuse them everywhere',
'notification_template_hero_text' => 'Maintain governed bilingual content for modules, schedulers and workflow escalations.',
'notification_template_hero_note_title' => 'Developer-ready templates',
'notification_template_hero_note_text' => 'Template and event codes connect application workflows to reusable messages.',
'notification_template_summary_label' => 'Template summary',
'notification_template_tab_basic' => 'Basic',
'notification_template_tab_content' => 'Content',
'notification_template_tab_action' => 'Action & Icon',
'notification_template_tab_advanced' => 'Advanced',
'notification_template_action_badge' => 'Action',
'notification_template_used_by' => 'Used by {count} notifications',
'notification_template_in_use_help' => 'Template is in use. Archive it instead.',
'notification_template_not_found' => 'Notification template not found.',
'notification_template_action_confirm' => 'Confirm this template action?',
'notification_template_confirm' => 'Confirm',
'notification_template_done' => 'Done.',
'notification_template_action_failed' => 'Template action failed.',
'notification_template_list_failed' => 'Unable to load notification templates.',
'notification_template_validation_required' => 'Template code, event code and Malay title are required.',
'notification_template_validation_body_length' => 'Template content must not exceed 10,000 characters.',
'notification_template_validation_unique' => 'Template code and event code must be unique.',
'notification_template_validation_json' => 'Placeholders must be valid JSON.',
'notification_template_validation_json_object' => 'Placeholders must be a JSON object with no more than 100 entries.',
'notification_template_help_template_code' => 'Unique template code, for example CORE_PASSWORD_REMINDER.',
'notification_template_help_event_code' => 'Event code used by application code when publishing the notification.',
'notification_template_help_module_code' => 'Owning module code, for example CORE, HR or FACILITY.',
'notification_template_help_type' => 'Default notification type used by this template.',
'notification_template_help_category' => 'Short grouping category such as system or approval.',
'notification_template_help_severity' => 'Controls the visual urgency of the notification.',
'notification_template_help_priority' => 'Controls ordering and emphasis for users.',
'notification_template_help_title_ms' => 'Malay title displayed to users.',
'notification_template_help_title_en' => 'English title used in English mode.',
'notification_template_help_body_ms' => 'Malay message. Supported placeholders may be included.',
'notification_template_help_body_en' => 'English message when required.',
'notification_template_help_action_label_ms' => 'Malay action-button label.',
'notification_template_help_action_label_en' => 'English action-button label.',
'notification_template_help_icon' => 'Default icon used by this template.',
'notification_template_help_placeholders' => 'JSON object describing variables accepted by the template.',
'notification_template_help_requires_action' => 'Enable when this template normally requires user action.',
'notification_template_help_status' => 'Only active templates can be selected for publication.',
'notification_icon_general' => 'General notification',
'notification_icon_announcement' => 'Announcement',
'notification_icon_warning' => 'Important warning',
'notification_icon_reminder' => 'Reminder / deadline',
'notification_icon_workflow' => 'Workflow task',
'notification_icon_success' => 'Successful / approved',
'notification_icon_issue' => 'Issue / rejected',
'notification_icon_security' => 'Security',
'notification_icon_account' => 'User account',
'notification_icon_document' => 'Document / form',
...
'systemCache_eyebrow' => 'Super Admin Maintenance',
'systemCache_hero_title' => 'Keep system cache healthy and controlled',
'systemCache_hero_subtitle' => 'Review discovered cache locations and perform a controlled cleanup without removing the directory structure.',
'systemCache_risk_title' => 'Sensitive operation',
'systemCache_risk_text' => 'Clearing all cache also resets available PHP runtime caches.',
'systemCache_state_enabled' => 'Enabled',
'systemCache_state_disabled' => 'Disabled',
'systemCache_state_unavailable' => 'Unavailable',
'systemCache_selected_none' => 'No locations selected',
'systemCache_selected_one' => '1 location selected',
'systemCache_selected_many' => '{count} locations selected',
'systemCache_select_all' => 'Select all cache locations',
'systemCache_select_location' => 'Select cache location',
'systemCache_location_standard' => 'Standard project cache',
'systemCache_confirm_selected_text' => 'The selected cache locations will be cleared.',
'systemCache_confirm_all_text' => 'All discovered cache locations, OPcache and APCu will be cleared.',
'systemCache_partial_title' => 'Cache partially cleared',
'systemCache_result_errors' => 'Items not cleared',
'systemCache_error_invalid_scope' => 'Invalid cache scope.',
'systemCache_error_invalid_location' => 'No valid cache locations were selected.',
'systemCache_error_busy' => 'Another cache maintenance operation is currently running.',
'systemCache_action_close' => 'Close',
...
// System settings — shell, security and AI Chatbot
'config_page_intro' => 'Manage core configuration, security, integrations and the system experience from one workspace.',
'config_page_global_notice' => 'Changes on this page may affect every user and system service.',
'config_rate_limit_title' => 'Too Many Requests',
'config_rate_limit_text' => 'Too many requests. Please try again shortly.',
'config_invalid_request_title' => 'Invalid Request',
'config_invalid_request_text' => 'The system settings request is invalid.',
'config_json_response_error' => 'The system response could not be generated.',
'config_method_not_allowed' => 'The request method is not allowed.',
'config_security_error_title' => 'Security Error',
'config_csrf_invalid_text' => 'The CSRF token is invalid. Reload the page and try again.',
'config_access_denied_title' => 'Access Denied',
'config_login_required_text' => 'Please sign in first.',
'config_super_admin_only_text' => 'Only Super Admin may access the System Settings page.',
'config_js_emel_uji_error_safe' => 'The email connection test failed. Check the configuration or system log.',
'config_ai_chatbot_validation_title' => 'Validation Error',
'config_ai_chatbot_success_title' => 'Success',
'config_ai_chatbot_success_text' => 'AI Chatbot settings saved successfully.',
'config_ai_chatbot_success_text_summary' => 'AI Chatbot settings saved successfully. Changes: %s.',
'config_ai_chatbot_save_error_title' => 'Save Error',
'config_ai_chatbot_save_error_text' => 'Unable to save AI Chatbot settings. Try again or contact the system administrator.',
'config_ai_chatbot_system_error_title' => 'System Error',
'config_ai_chatbot_system_error_text' => 'A system error occurred while saving AI Chatbot settings. Check the system log for details.',

// Audit Center
'audit_center_page_title' => 'Audit Center',
'audit_center_breadcrumb_dashboard' => 'Dashboard',
'audit_center_access_denied_title' => 'Access Denied',
'audit_center_access_denied_text' => 'Audit Center is available to Super Admin only.',
'audit_center_hero_eyebrow' => 'Audit Oversight',
'audit_center_hero_title' => 'Operational Audit Workspace',
'audit_center_hero_text' => 'Review activity, requests, sessions, changes, and security signals from one controlled workspace.',
'audit_center_chip_ajax' => 'Live Data',
'audit_center_chip_live_paging' => 'Server Paging',
'audit_center_chip_super_admin' => 'Super Admin',
'audit_center_nav_title' => 'Audit Views',
'audit_center_tab_events' => 'Events',
'audit_center_tab_requests' => 'Requests',
'audit_center_tab_sessions' => 'Sessions',
'audit_center_tab_changes' => 'Changes',
'audit_center_tab_security' => 'Security',
'audit_center_loading_summary' => 'Loading audit summary...',
'audit_center_loading_panel' => 'Loading audit data...',
'audit_center_load_failed' => 'Audit Center data could not be loaded. Please try again.',
'audit_center_filter_search' => 'Search',
'audit_center_filter_search_placeholder' => 'Search login ID, route, request ID, IP, or actor',
'audit_center_filter_limit' => 'Limit',
'audit_center_filter_advanced_toggle' => 'Advanced',
'audit_center_filter_reset' => 'Reset',
'audit_center_filter_apply' => 'Apply Filters',
'audit_center_filter_date_from' => 'Date From',
'audit_center_filter_date_to' => 'Date To',
'audit_center_filter_event_type' => 'Event Type',
'audit_center_export_csv' => 'Export CSV',
'audit_center_export_json' => 'Export JSON',
'audit_center_export_rate_limited' => 'Too many export requests. Please wait.',
'audit_center_panel_rate_limited' => 'Too many Audit Center requests. Please wait.',
'audit_center_summary_events_today' => 'Events Today',
'audit_center_summary_security_today' => 'Security Today',
'audit_center_summary_active_sessions' => 'Active Sessions',
'audit_center_summary_active_lockouts' => 'Active Lockouts',
'audit_center_summary_active_throttles' => 'Active Throttles',
'audit_center_events_title' => 'Recent Events',
'audit_center_requests_title' => 'Request Trace',
'audit_center_sessions_title' => 'Session Activity',
'audit_center_changes_title' => 'Change Tracking',
'audit_center_security_events_title' => 'Recent Security Events',
'audit_center_security_lockouts_title' => 'Active Lockouts',
'audit_center_security_throttles_title' => 'Active Throttles',
'audit_center_page_label' => 'Page',
'audit_center_page_of' => 'of',
'audit_center_pager_total' => 'Total',
'audit_center_pager_records' => 'records',
'audit_center_pager_prev' => 'Previous',
'audit_center_pager_next' => 'Next',
'audit_center_action_view_metadata' => 'View Metadata',
'audit_center_action_clear_lockout' => 'Clear Lockout',
'audit_center_action_clear_throttle' => 'Clear Throttle',
'audit_center_action_terminate_session' => 'Terminate Session',
'audit_center_action_confirm_button' => 'Continue',
'audit_center_action_cancel_button' => 'Cancel',
'audit_center_action_success_title' => 'Action Successful',
'audit_center_action_error_title' => 'Action Failed',
'audit_center_action_ok_button' => 'OK',
'audit_center_action_clear_lockout_title' => 'Clear this lockout?',
'audit_center_action_clear_lockout_text' => 'The active lockout for this login ID will be cleared immediately.',
'audit_center_action_clear_throttle_title' => 'Clear this throttle?',
'audit_center_action_clear_throttle_text' => 'The active throttle for this scope will be cleared immediately.',
'audit_center_action_terminate_session_title' => 'Terminate this session?',
'audit_center_action_terminate_session_text' => 'This session will be terminated immediately and the user must sign in again.',
'audit_center_action_rate_limited' => 'Too many actions. Please wait.',
'audit_center_action_server_error' => 'A system error occurred while processing the Audit Center action.',
'audit_center_meta_modal_title' => 'Audit Metadata Viewer',
'audit_center_meta_close_button' => 'Close',
'audit_center_meta_loading_title' => 'Loading Metadata',
'audit_center_meta_loading_text' => 'Please wait while audit metadata is loaded.',
'audit_center_meta_section_raw_record' => 'Raw Record',
'audit_center_meta_section_fallback' => 'Section',
'audit_center_meta_copy_button' => 'Copy JSON',
'audit_center_meta_copy_success' => 'JSON copied',
'audit_center_meta_empty' => 'No additional metadata was recorded for this item.',
'audit_center_meta_rate_limited' => 'Too many metadata requests. Please wait.',
'audit_center_meta_invalid_kind' => 'Invalid metadata type.',
'audit_center_meta_not_found' => 'Metadata record was not found.',
'audit_center_meta_server_error' => 'A system error occurred while loading audit metadata.',
'audit_center_meta_title_event' => 'Event Metadata',
'audit_center_meta_title_request' => 'Request Metadata',
'audit_center_meta_title_session' => 'Session Metadata',
'audit_center_meta_title_change' => 'Change Set Metadata',
'audit_center_meta_title_lockout' => 'Lockout Metadata',
'audit_center_meta_title_throttle' => 'Throttle Metadata',
'audit_center_meta_section_event_meta' => 'Event Metadata',
'audit_center_meta_section_change_sets' => 'Related Change Sets',
'audit_center_meta_section_related_events' => 'Related Events',
'audit_center_meta_section_change_meta' => 'Change Set Metadata',
'audit_center_meta_section_field_changes' => 'Field Changes',
'audit_center_detail_masked' => '[MASKED]',
'audit_center_detail_yes' => 'Yes',
'audit_center_detail_no' => 'No',
'audit_center_detail_old_value' => 'Old Value',
'audit_center_detail_new_value' => 'New Value',
'audit_center_detail_sensitive' => 'Sensitive',
'audit_center_detail_field' => 'Field',
'audit_center_detail_data_type' => 'Data Type',
'audit_center_detail_empty' => 'No additional details.',
'audit_center_col_actor' => 'Actor',
'audit_center_col_event' => 'Event',
'audit_center_col_outcome' => 'Outcome',
'audit_center_col_status' => 'Status',
'audit_center_col_user' => 'User',
'audit_center_col_route' => 'Route',
'audit_center_col_method' => 'Method',
'audit_center_col_duration' => 'Duration',
'audit_center_col_target' => 'Target',
'audit_center_col_reason' => 'Reason',
'audit_center_col_fields' => 'Fields',
'audit_center_col_attempts' => 'Attempts',
'audit_center_col_scope' => 'Scope',
'audit_center_col_scope_key' => 'Scope Key',
'audit_center_action_invalid_payload' => 'Invalid action payload.',
'audit_center_action_method_not_allowed' => 'Method not allowed.',
'audit_center_action_invalid_type' => 'Invalid action type.',
'audit_center_action_lockout_missing' => 'Lockout login ID was not provided.',
'audit_center_action_lockout_failed' => 'The lockout could not be cleared.',
'audit_center_action_lockout_cleared' => 'Lockout cleared successfully.',
'audit_center_action_throttle_missing' => 'Throttle information is incomplete.',
'audit_center_action_throttle_failed' => 'The throttle could not be cleared.',
'audit_center_action_throttle_cleared' => 'Throttle cleared successfully.',
'audit_center_action_session_missing' => 'Session ID was not provided.',
'audit_center_action_session_current_forbidden' => 'The current session cannot be terminated from Audit Center.',
'audit_center_action_session_failed' => 'The session could not be terminated or has already ended.',
'audit_center_action_session_terminated' => 'Session terminated successfully.',
'audit_center_changes_no_fields' => 'No field changes were recorded.',
'audit_center_detail_diff_hint' => 'Difference Hint',
'audit_center_tab_events_text' => 'Review the latest system audit events, outcomes, actors, and targets.',
'audit_center_tab_requests_text' => 'Inspect request routes, status codes, and processing duration.',
'audit_center_tab_sessions_text' => 'Review active and historical audited sessions and devices.',
'audit_center_tab_changes_text' => 'Inspect field-level changes for forensic review.',
'audit_center_tab_security_text' => 'Monitor security events, active lockouts, and active throttles.',
'audit_center_summary_events_today_text' => 'Audit events recorded today.',
'audit_center_summary_security_today_text' => 'Authentication and security signals detected today.',
'audit_center_summary_active_sessions_text' => 'Audited sessions currently active.',
'audit_center_summary_active_lockouts_text' => 'Active login ID lockouts.',
'audit_center_summary_active_throttles_text' => 'Active login and IP throttles.',
'audit_center_detail_login_id' => 'Login ID', 'audit_center_detail_ip' => 'IP', 'audit_center_detail_severity' => 'Severity',
'audit_center_detail_target_type' => 'Target Type', 'audit_center_col_session_id' => 'Session ID', 'audit_center_detail_scope_type' => 'Scope Type',
'audit_center_events_empty' => 'No audit events were found.', 'audit_center_col_occurred' => 'Occurred', 'audit_center_detail_user_id' => 'User ID',
'audit_center_detail_request_id' => 'Request ID', 'audit_center_detail_session_id' => 'Session ID', 'audit_center_detail_target_id' => 'Target ID',
'audit_center_detail_target_label' => 'Target Label', 'audit_center_detail_message' => 'Message', 'audit_center_requests_empty' => 'No request traces were found.',
'audit_center_col_started' => 'Started', 'audit_center_detail_ended_at' => 'Ended At', 'audit_center_detail_route' => 'Route',
'audit_center_sessions_empty' => 'No audited sessions were found.', 'audit_center_detail_user' => 'User', 'audit_center_detail_user_agent' => 'User Agent',
'audit_center_detail_legacy_identifier' => 'Legacy Identifier', 'audit_center_changes_empty' => 'No change sets were found.', 'audit_center_col_changed_at' => 'Changed At',
'audit_center_detail_change_set_id' => 'Change Set ID', 'audit_center_detail_event_id' => 'Event ID', 'audit_center_detail_actor' => 'Actor',
'audit_center_detail_event_type' => 'Event Type', 'audit_center_detail_change_reason' => 'Change Reason',
'audit_center_security_events_empty' => 'No security events were found.', 'audit_center_security_lockouts_empty' => 'No active lockouts were found.',
'audit_center_col_locked_until' => 'Locked Until', 'audit_center_detail_last_failed_at' => 'Last Failed At',
'audit_center_security_throttles_empty' => 'No active throttles were found.',
'emailTemplate_governance_title' => 'Controlled email content',
'emailTemplate_governance_text' => 'Preview placeholders and verify recipients before sending.',
'emailTemplate_unsaved_indicator' => 'Unsaved changes',
'emailTemplate_unsaved_confirm_title' => 'Discard unsaved changes?',
'emailTemplate_unsaved_confirm_text' => 'Changes made in this template have not been saved.',
'emailTemplate_unsaved_confirm_discard' => 'Discard changes',
'emailTemplate_test_confirm_title' => 'Send test email?',
'emailTemplate_test_confirm_text' => 'Confirm the recipient and subject before sending.',
'emailTemplate_test_confirm_button' => 'Send test email',
'emailTemplate_test_recipient_label' => 'Recipient',
'emailTemplate_test_subject_label' => 'Subject',
'emailTemplate_external_resource_warning' => 'External images or links may contact third-party servers when recipients open the email.',
'emailTemplate_error_bootstrap' => 'Unable to load email template management at this time.',
];
