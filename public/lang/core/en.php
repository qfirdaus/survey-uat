...
'config_ai_chatbot_knowledge_manager' => 'Knowledge Manager',
'config_ai_chatbot_review_dashboard' => 'Review Dashboard',
'config_ai_chatbot_core_settings' => 'AI Chatbot Core Settings',
'config_ai_chatbot_enable' => 'Enable AI Chatbot',
'config_ai_chatbot_access_mode' => 'Access mode',
'config_ai_chatbot_allowed_groups' => 'Allowed groups',
'config_ai_chatbot_provider' => 'Provider',
'config_ai_chatbot_model' => 'Model',
'config_ai_chatbot_model_placeholder' => 'Select model',
'config_ai_chatbot_model_status_fetch' => 'The model list will be fetched dynamically from the selected provider.',
'config_ai_chatbot_base_url' => 'Provider base URL',
'config_ai_chatbot_api_key' => 'API key',
'config_ai_chatbot_api_key_keep' => 'An API key is already set. Leave blank to keep the current value.',
'config_ai_chatbot_api_key_enter' => 'Enter an API key if the provider requires one.',
'config_ai_chatbot_timeout_seconds' => 'Timeout seconds',
'config_ai_chatbot_max_input_chars' => 'Max input chars',
'config_ai_chatbot_max_output_tokens' => 'Max output tokens',
'config_ai_chatbot_rate_per_minute' => 'Rate per minute',
'config_ai_chatbot_user_daily_limit' => 'User daily request limit',
'config_ai_chatbot_global_daily_limit' => 'Global daily request limit',
'config_ai_chatbot_character_name' => 'Character name',
'config_ai_chatbot_avatar_path' => 'Avatar path',
'config_ai_chatbot_welcome_message' => 'Welcome message',
'config_ai_chatbot_persist_usage' => 'Persist usage',
'config_ai_chatbot_store_conversations' => 'Store conversations',
'config_ai_chatbot_log_message_content' => 'Log message content',
'config_ai_chatbot_app_url' => 'App URL',
'config_ai_chatbot_app_title' => 'App title',
'config_ai_chatbot_storage_note' => 'All AI Chatbot settings are stored in the tbl_m_config ai_chatbot group.',
'config_ai_chatbot_save_settings' => 'Save AI Chatbot Settings',
'config_ai_chatbot_model_fetch_failed' => 'Failed to fetch model list. HTTP %s',
'config_ai_chatbot_project_context_tab' => 'Project Context',
'config_ai_chatbot_project_context_title' => 'Project-Aware Data Context',
'config_ai_chatbot_project_context_subtitle' => 'Diagnostic for provider matching based on system.name.',
'config_ai_chatbot_project_status_matched' => 'Matched',
'config_ai_chatbot_project_status_core_only' => 'Core only',
'config_ai_chatbot_project_status_no_provider' => 'No project provider',
'config_ai_chatbot_project_status_ambiguous' => 'Ambiguous',
'config_ai_chatbot_project_status_error' => 'Error',
'config_ai_chatbot_project_system_name' => 'System name',
'config_ai_chatbot_project_normalized_identity' => 'Normalized identity',
'config_ai_chatbot_project_provider' => 'Matched provider',
'config_ai_chatbot_project_none' => 'None',
'config_ai_chatbot_project_matched_alias' => 'Matched alias',
'config_ai_chatbot_project_match_score' => 'Match score',
'config_ai_chatbot_project_minimum' => 'Minimum',
'config_ai_chatbot_project_provider_code' => 'Provider code',
'config_ai_chatbot_project_provider_label' => 'Provider label',
'config_ai_chatbot_project_score' => 'Score',
'config_ai_chatbot_project_alias' => 'Alias',
'config_ai_chatbot_project_status' => 'Status',
'config_ai_chatbot_project_no_providers' => 'No project provider has been registered yet.',
'config_ai_chatbot_project_context_note' => 'If the system name changes and no provider matches, chatbot will use core context and knowledge base only.',
'aiChatbotKnowledge_page_title' => 'AI Chatbot Knowledge Manager',
'aiChatbotKnowledge_permission_denied' => 'You do not have permission to manage AI Chatbot knowledge.',
'aiChatbotKnowledge_breadcrumb_knowledge' => 'Knowledge',
'aiChatbotKnowledge_create_title' => 'Create Knowledge Item',
'aiChatbotKnowledge_edit_title' => 'Edit Knowledge Item',
'aiChatbotKnowledge_modal_subtitle' => 'Curated context by visibility and group.',
'aiChatbotKnowledge_manual_tab' => 'Manual Text',
'aiChatbotKnowledge_pdf_tab' => 'PDF Source',
'aiChatbotKnowledge_content_tab' => 'Content',
'aiChatbotKnowledge_access_tab' => 'Access',
'aiChatbotKnowledge_review_tab' => 'Review',
'aiChatbotKnowledge_title_label' => 'Title',
'aiChatbotKnowledge_question_label' => 'Question',
'aiChatbotKnowledge_answer_label' => 'Answer',
'aiChatbotKnowledge_tags_label' => 'Tags',
'aiChatbotKnowledge_language_label' => 'Language',
'aiChatbotKnowledge_status_label' => 'Status',
'aiChatbotKnowledge_visibility_label' => 'Visibility',
'aiChatbotKnowledge_priority_label' => 'Priority',
'aiChatbotKnowledge_allowed_groups_label' => 'Allowed groups',
'aiChatbotKnowledge_allowed_groups_help' => 'Required when visibility is selected groups.',
'aiChatbotKnowledge_source_review_title' => 'Source & Review',
'aiChatbotKnowledge_source_review_help' => 'Use this metadata for policy references, versions, and review dates.',
'aiChatbotKnowledge_source_title_label' => 'Source title',
'aiChatbotKnowledge_version_label' => 'Version',
'aiChatbotKnowledge_review_status_label' => 'Review status',
'aiChatbotKnowledge_effective_date_label' => 'Effective date',
'aiChatbotKnowledge_review_due_date_label' => 'Review due date',
'aiChatbotKnowledge_pdf_upload_title' => 'Upload PDF policy or system flow',
'aiChatbotKnowledge_pdf_upload_help' => 'PDF only. Maximum size follows System Settings: %s MB.',
'aiChatbotKnowledge_pdf_file_label' => 'PDF file',
'aiChatbotKnowledge_pdf_note' => 'The PDF will be stored as a draft source. The system will try to extract text and generate draft chunks after upload.',
'aiChatbotKnowledge_pdf_source_missing' => 'The PDF source table is not available. Please make sure the PDF schema migration has been applied.',
'aiChatbotKnowledge_pdf_chunk_missing' => 'The PDF chunk table is not available. Upload and extraction can run, but chunks will not be generated.',
'aiChatbotKnowledge_uploaded_pdf_title' => 'Uploaded PDF Sources',
'aiChatbotKnowledge_uploaded_pdf_help' => 'Extracted text is stored as a sidecar .txt file; chunks are used by the chatbot only after the PDF source is activated.',
'aiChatbotKnowledge_no_pdf_source' => 'No PDF source has been uploaded.',
'aiChatbotKnowledge_footer_note' => 'Content is used only after status and visibility allow retrieval.',
'aiChatbotKnowledge_close' => 'Close',
'aiChatbotKnowledge_save' => 'Save Knowledge',
'aiChatbotKnowledge_update' => 'Update Knowledge',
'aiChatbotKnowledge_upload_pdf' => 'Upload PDF',
'aiChatbotKnowledge_registry_title' => 'Knowledge Registry',
'aiChatbotKnowledge_registry_subtitle' => 'Only active items are sent to the provider after language and visibility filtering.',
'aiChatbotKnowledge_create_button' => 'Create Knowledge Item',
'aiChatbotKnowledge_settings_button' => 'AI Chatbot Settings',
'aiChatbotKnowledge_table_title' => 'Title',
'aiChatbotKnowledge_table_context' => 'Context',
'aiChatbotKnowledge_table_retrieval' => 'Retrieval',
'aiChatbotKnowledge_table_actions' => 'Actions',
'aiChatbotKnowledge_show' => 'Show',
'aiChatbotKnowledge_hide' => 'Hide',
'aiChatbotKnowledge_edit_tooltip' => 'Edit knowledge',
'aiChatbotKnowledge_delete_tooltip' => 'Delete knowledge',
'aiChatbotKnowledge_swal_success_title' => 'Success',
'aiChatbotKnowledge_swal_error_title' => 'Not successful',
'aiChatbotKnowledge_swal_close' => 'Close',
'aiChatbotKnowledge_delete_confirm_title' => 'Delete knowledge item?',
'aiChatbotKnowledge_delete_confirm_text' => 'This action cannot be undone.',
'aiChatbotKnowledge_delete_confirm_button' => 'Delete',
'aiChatbotKnowledge_cancel' => 'Cancel',
'aiChatbotKnowledge_loading_opening' => 'Opening',
'aiChatbotKnowledge_loading_saving' => 'Saving',
'aiChatbotKnowledge_loading_uploading' => 'Uploading',
'aiChatbotKnowledge_error_reload_table' => 'Failed to reload the datatable.',
'aiChatbotKnowledge_error_update_table' => 'The datatable could not be updated.',
'aiChatbotKnowledge_error_action_failed' => 'The action could not be processed.',
'aiChatbotKnowledge_error_open_failed' => 'The knowledge item could not be opened.',
'aiChatbotKnowledge_error_save_failed' => 'The knowledge item could not be saved.',
'aiChatbotKnowledge_error_pdf_failed' => 'The PDF source could not be processed.',
'aiChatbotKnowledge_success_action' => 'Action processed successfully.',
'aiChatbotKnowledge_success_save' => 'Knowledge item saved successfully.',
'aiChatbotKnowledge_success_pdf' => 'PDF source processed successfully.',
'aiChatbotKnowledge_search_placeholder' => 'Search knowledge...',
'aiChatbotReview_page_title' => 'AI Chatbot Review Dashboard',
'aiChatbotReview_permission_denied' => 'You do not have permission to view the AI Chatbot Review Dashboard.',
'aiChatbotReview_knowledge_manager' => 'Knowledge Manager',
'aiChatbotReview_summary_review_queue' => 'Review Queue',
'aiChatbotReview_summary_no_knowledge' => 'No Knowledge',
'aiChatbotReview_summary_provider_failures' => 'Provider Failures',
'aiChatbotReview_summary_total_requests' => 'Total Requests',
'aiChatbotReview_tab_review_queue' => 'Review Queue',
'aiChatbotReview_tab_no_knowledge' => 'No Knowledge',
'aiChatbotReview_tab_provider_failures' => 'Provider Failures',
'aiChatbotReview_table_time' => 'Time',
'aiChatbotReview_table_user' => 'User',
'aiChatbotReview_table_provider' => 'Provider',
'aiChatbotReview_table_outcome' => 'Outcome',
'aiChatbotReview_table_review' => 'Review',
'aiChatbotReview_filter_days' => 'Days',
'aiChatbotReview_filter_rows' => 'Rows',
'aiChatbotReview_filter_apply' => 'Apply',
'aiChatbotReview_search_placeholder' => 'Search review...',
...
// Developer Guide
// =========================
'developerGuide_page_title'      => 'Developer Guide',
'developerGuide_forbidden'       => 'You do not have permission to view the developer guide.',
...
'developerGuide_core_safe_badge' => 'Core-safe reference',
'developerGuide_heading'         => 'Central developer guide for IQS Framework modules',
'developerGuide_intro'           => 'Use this page as the standard reference for building project modules without editing protected framework core files. Copy the samples, keep module logic in project files, and configure access through the system UI.',
'developerGuide_overview_title'  => 'Core-safe development rules',
'developerGuide_overview_text'   => 'Programmers should build project modules by consuming framework APIs and UI-managed configuration, not by editing core runtime files.',
...
'impersonation_view_as_action'   => 'View As user',
'impersonation_start_title'      => 'Start View As User',
'impersonation_start_text'       => 'You will view the system as this user. Choose the right mode for the support case.',
'impersonation_mode_label'       => 'View As Mode',
'impersonation_mode_view_only'   => 'View Only',
'impersonation_mode_support_action'=> 'Support Action',
'impersonation_mode_help'        => 'View Only blocks changes. Support Action allows changes and audits every write request.',
'impersonation_reason_label'     => 'Reason / Ticket no.',
'impersonation_reason_placeholder'=> 'Example: Ticket ICT-1234, checking dashboard menu access.',
'impersonation_reason_required'  => 'Reason is required before View As can start.',
'impersonation_start_button'     => 'Start View As',
'impersonation_stop_button'      => 'Stop View As',
'impersonation_stopping'         => 'Stopping...',
'impersonation_banner_prefix'    => 'Viewing as',
'impersonation_banner_actor'     => 'Actor',
'impersonation_view_only_blocked'=> 'View As mode is read-only. Stop View As before making changes.',
'impersonation_start_success'    => 'View As mode started.',
'impersonation_stop_success'     => 'View As mode stopped.',
'impersonation_already_active'   => 'View As mode is already active.',
'impersonation_required'         => 'Target user and reason are required.',
'impersonation_forbidden'        => 'You do not have permission to use View As.',
'impersonation_target_not_found' => 'Target user was not found.',
'impersonation_target_disabled'  => 'Target user account is disabled.',
'impersonation_self_denied'      => 'You cannot View As your own account.',
'impersonation_super_admin_denied'=> 'View As is not allowed for Super Admin accounts.',
'impersonation_start_failed'     => 'Unable to start View As mode.',
'impersonation_not_active'       => 'View As mode is not active.',
'impersonation_stop_failed'      => 'Unable to stop View As mode.',
'impersonation_timeout_message'  => 'View As session expired. Please start View As again if needed.',
'impersonation_rate_limited'     => 'Too many View As attempts. Please try again later.',
'impersonation_loading_start'    => 'Preparing View As...',
'impersonation_loading_stop'     => 'Restoring your account...',
...
'modul_ajax_only_guard'             => 'Module creation must use the system modal so the audit trail is recorded.',
...
'config_general_impersonation_timeout_minutes' => 'View As Timeout (Minutes)',
...
'config_general_subtab_limits_note' => 'These behavior limits affect session inactivity timeout, View As sessions, and the maximum manual upload size.',
...
'config_general_impersonation_timeout_minutes_help' => 'View As session duration before the system automatically restores the original account.',
...
'pageTemplateGenerator_governance_title' => 'Governance Checklist',
'pageTemplateGenerator_governance_text' => 'Generated pages must keep language keys, access registration, and audit hooks aligned before production use.',
'pageTemplateGenerator_governance_language' => 'Language keys',
'pageTemplateGenerator_governance_audit' => 'Audit hooks',
'pageTemplateGenerator_governance_access' => 'Access control',
...
'unauthorized_access' => 'Please log in first.',

'session_terminated_title' => 'Session Terminated',
'session_terminated_text' => 'Your session has been terminated by an administrator. Please log in again.',
'session_terminated_ok' => 'OK',

'config_auth_sso_site_id_required' => 'OneID Site ID cannot be empty.',
'config_auth_sso_site_id_invalid' => 'OneID Site ID may only contain letters, numbers, underscores (_) or hyphens (-).',
'config_auth_sso_idp_domain_required' => 'OneID IdP Domain cannot be empty.',
'config_auth_sso_idp_domain_invalid' => 'OneID IdP Domain must be a valid URL.',
'config_auth_sso_idp_domain_scheme_invalid' => 'OneID IdP Domain must use http:// or https://',
'config_auth_hybrid_option_sso' => 'SSO',
'config_auth_hybrid_option_manual' => 'Manual',
...
'profile_audit_view_summary' => 'View audit summary',
'profile_js_copy_empty' => 'No text to copy',
'profile_js_copy_wait' => 'Please wait before copying again',
'profile_js_copy_failed' => 'Failed to copy text',
'profile_max_file_size' => 'Maximum file size is 5MB',
'profile_student_card_label' => 'Student Profile',
'profile_user_card_label' => 'User Profile',

'userList_sync_student_group_missing' => 'Student group has not been configured.',
'userList_sync_student_no_data' => 'No student data to sync.',
'userList_sync_student_result_message' => 'Student sync completed. %d records inserted, %d updated, %d skipped, %d errors.',
'userList_sync_student_error' => 'System error while syncing student data.',

'prestasi_js_table_empty' => 'No records found',
'prestasi_js_year_selected_title' => 'Year selected',
'prestasi_js_year_selected_text' => 'The view has been updated for the selected year.',
'prestasi_js_ok' => 'OK',
'prestasi_js_cancel' => 'Cancel',
'prestasi_js_saving' => 'Saving...',
'prestasi_js_success_title' => 'Success',
'prestasi_js_error_title' => 'Error',
'prestasi_js_non_json_prefix' => 'Invalid server response',
'prestasi_js_reminder_confirm_title' => 'Send reminder?',
'prestasi_js_email_missing_title' => 'Email missing',
'prestasi_js_email_missing_text' => 'The recipient email address is not available.',
'prestasi_js_reminder_sent_title' => 'Reminder sent',
'prestasi_js_reminder_sent_text' => 'The email reminder has been sent.',
'prestasi_js_reminder_failed_default' => 'Unable to send reminder.',
'prestasi_js_server_error_prefix' => 'Server error',
'prestasi_js_reminder_intro' => 'A reminder will be sent to the selected evaluator.',
'prestasi_js_reminder_footer' => 'Make sure the recipient information is correct.',
'prestasi_js_reminder_btn_send' => 'Send',
'prestasi_badge_complete' => 'Complete',
'prestasi_badge_incomplete' => 'Incomplete',
'prestasi_badge_not_filled' => 'Not Filled',
'prestasi_badge_same_person_empty' => 'Same Evaluator',
'prestasi_badge_tiada' => 'None',
'prestasi_tt_same_person_single_tier' => 'PPP and PPK are the same person.',
'prestasi_tt_ppp_not_filled_two_tier' => 'PPP score has not been filled.',
'prestasi_tt_ppk_not_filled_two_tier' => 'PPK score has not been filled.',
'prestasi_tt_edit' => 'Update score',
'prestasi_tt_reminder_ppp' => 'Send reminder to PPP',
'prestasi_tt_reminder_ppk' => 'Send reminder to PPK',
