...
'profile_note_label'            => 'Nota',
'profile_login_activity_heading'=> 'Keselamatan Sesi',
'profile_login_activity_intro'  => 'Semak sejarah akses, peranti yang digunakan dan tamatkan sesi aktif yang tidak lagi dikenali.',
'profile_audit_heading'         => 'Rekod Aktiviti Akaun',
'profile_audit_intro'           => 'Jejaki aktiviti penting yang direkodkan untuk akaun ini serta keputusan setiap tindakan.',

// Makluman simpan bahasa
'profile_alert_security_title'  => 'Ralat Keselamatan',
'profile_alert_security_text'   => 'Token keselamatan tidak sah. Sila muat semula halaman dan cuba lagi.',
'profile_alert_access_title'    => 'Akses Ditolak',
'profile_alert_access_text'     => 'Sesi pengguna tidak sah. Sila log masuk semula.',
'profile_alert_validation_title'=> 'Ralat Validasi',
'profile_alert_validation_text' => 'Sila pilih bahasa yang aktif dan sah.',
'profile_alert_save_title'      => 'Ralat Menyimpan',
'profile_alert_save_text'       => 'Tiada perubahan disimpan atau kemas kini gagal diproses.',
'profile_alert_system_title'    => 'Ralat Sistem',
'profile_alert_system_text'     => 'Ralat berlaku semasa menyimpan pilihan bahasa anda.',
...
// Developer Guide
// =========================
'developerGuide_page_title'      => 'Panduan Pembangun',
'developerGuide_forbidden'       => 'Anda tidak mempunyai kebenaran untuk melihat panduan pembangun.',
'developerGuide_tab_overview'    => 'Ringkasan',
'developerGuide_tab_page'        => 'Rangka Halaman',
'developerGuide_tab_service'     => 'Corak Servis',
'developerGuide_tab_database'    => 'Pangkalan Data',
'developerGuide_tab_ajax'        => 'AJAX & CSRF',
'developerGuide_tab_notification'=> 'Notifikasi',
'developerGuide_tab_language'    => 'Bahasa',
'developerGuide_tab_menu'        => 'Menu & Akses',
'developerGuide_tab_audit'       => 'Audit',
'developerGuide_tab_email'       => 'E-mel',
'developerGuide_tab_ui'          => 'Corak UI',
'developerGuide_tab_checklist'   => 'Senarai Semak',
'developerGuide_copy'            => 'Salin',
'developerGuide_copied'          => 'Disalin',
'developerGuide_core_safe_badge' => 'Rujukan selamat teras',
'developerGuide_heading'         => 'Panduan pembangun berpusat untuk modul IQS Framework',
'developerGuide_intro'           => 'Gunakan halaman ini sebagai rujukan standard untuk membina modul projek tanpa mengubah fail teras framework. Salin contoh kod, kekalkan logik modul dalam fail projek dan konfigurasi akses melalui UI sistem.',
'developerGuide_overview_title'  => 'Peraturan pembangunan selamat teras',
'developerGuide_overview_text'   => 'Pembangun perlu membina modul projek menggunakan API framework dan konfigurasi UI, bukan mengubah fail runtime teras.',
'developerGuide_copy_code'       => 'Salin contoh kod',
'developerGuide_copy_path'       => 'Salin laluan dokumen',
'developerGuide_kpi_topics'      => 'Topik panduan',
'developerGuide_kpi_samples'     => 'Contoh kod',
'developerGuide_kpi_references'  => 'Rujukan',
'developerGuide_current_title'   => 'Selaras dengan framework',
'developerGuide_current_text'    => 'Contoh mengikuti corak keselamatan dan audit semasa.',
'developerGuide_search_label'    => 'Cari dalam panduan',
'developerGuide_search_placeholder' => 'Cari topik, peraturan atau contoh...',
'developerGuide_clear_search'    => 'Kosongkan carian',
'developerGuide_search_result'   => '%d topik sepadan dengan carian',
'developerGuide_search_no_result'=> 'Tiada topik sepadan dengan carian.',
'developerGuide_ui_rules'        => 'Peraturan',
'developerGuide_ui_references'   => 'Rujukan',
'developerGuide_ui_core_boundary'=> 'Sempadan Teras',
'developerGuide_ui_page_file'    => 'Fail Halaman',
'developerGuide_ui_controller'   => 'Pengawal',
'developerGuide_ui_separation'   => 'Pemisahan',
'developerGuide_ui_sample'       => 'Contoh',
'developerGuide_ui_main_mysql'   => 'MySQL Utama',
'developerGuide_ui_additional_db'=> 'Pangkalan Data Tambahan',
'developerGuide_ui_transaction'  => 'Transaksi',
'developerGuide_ui_endpoint'     => 'Endpoint',
'developerGuide_ui_external_service' => 'Perkhidmatan Luaran',
'developerGuide_ui_event'        => 'Peristiwa',
'developerGuide_ui_workflow'     => 'Aliran Kerja',
'developerGuide_ui_admin_samples'=> 'Contoh Pentadbir',
'developerGuide_ui_custom_keys'  => 'Key Tersuai',
'developerGuide_ui_setup_flow'   => 'Aliran Persediaan',
'developerGuide_ui_reference'    => 'Rujukan',
'developerGuide_ui_audit_event'  => 'Peristiwa Audit',
'developerGuide_ui_view_as'      => 'Lihat Sebagai',
'developerGuide_ui_template'     => 'Templat',
'developerGuide_ui_components'   => 'Komponen',
'developerGuide_ui_boundary'     => 'Sempadan',
'developerGuide_ui_before_coding'=> 'Sebelum Membangun',
'developerGuide_ui_before_handover' => 'Sebelum Serahan',
'developerGuide_rule_do_title'   => 'Lakukan',
'developerGuide_rule_do_text'    => 'Gunakan servis, pengawal, pembantu AJAX, fail bahasa tersuai dan persediaan menu serta akses melalui UI.',
'developerGuide_rule_dont_title' => 'Jangan Lakukan',
'developerGuide_rule_dont_text'  => 'Jangan ubah sidebar, topbar, init, teras Database, Notification, Audit atau fail bahasa teras untuk keperluan projek.',
'developerGuide_rule_register_title' => 'Daftarkan',
'developerGuide_rule_register_text' => 'Selepas membina halaman, daftarkan modul, menu, subkumpulan dan akses kumpulan melalui Kumpulan Pengguna, bukan kod sumber.',
'developerGuide_recommended_flow'=> 'Aliran disyorkan: jana atau bina fail halaman, tambah pengawal, servis dan AJAX, tambah key bahasa dalam fail tersuai, daftarkan menu serta akses melalui UI, kemudian uji authorization dan audit.',
...
'profile_login_kill_error_no_session'
                                => 'ID sesi tidak sah',
'profile_session_rate_limit'    => 'Terlalu banyak percubaan. Sila tunggu sebentar.',
'profile_session_method_invalid'=> 'Kaedah permintaan tidak dibenarkan.',
'profile_session_json_invalid'  => 'Input JSON tidak sah.',
'profile_session_id_required'   => 'ID sesi tidak ditentukan.',
'profile_session_current_denied'=> 'Sesi semasa tidak boleh ditamatkan.',
'profile_session_login_required'=> 'Sila log masuk terlebih dahulu.',
'profile_session_user_not_found'=> 'Pengguna tidak ditemui.',
'profile_session_not_owned'     => 'Sesi tidak ditemui atau bukan milik anda.',
'profile_session_already_ended' => 'Sesi ini sudah tamat.',
'profile_session_terminate_success' => 'Sesi berjaya ditamatkan.',
'profile_session_terminate_failed'  => 'Gagal menamatkan sesi. Sesi mungkin sudah tamat.',
'profile_session_database_error'    => 'Ralat pangkalan data. Sila cuba lagi.',
'profile_session_system_error'      => 'Ralat sistem. Sila cuba lagi.',
...
'profile_audit_stat_sets'       => 'Set',
'profile_audit_stat_changes'    => 'Beza',
'profile_audit_outcome_success' => 'Berjaya',
'profile_audit_outcome_failure' => 'Gagal',
'profile_audit_outcome_unknown' => 'Tidak Diketahui',
'profile_audit_severity_security' => 'Keselamatan',
'profile_audit_severity_warning'  => 'Amaran',
'profile_audit_severity_info'     => 'Maklumat',
'profile_audit_severity_unknown'  => 'Tidak Diketahui',
'profile_audit_event_create'    => 'Cipta',
'profile_audit_event_update'    => 'Kemas Kini',
'profile_audit_event_delete'    => 'Padam',
'profile_audit_event_login'     => 'Log Masuk',
'profile_audit_event_logout'    => 'Log Keluar',
'profile_audit_event_view'      => 'Lihat',
'profile_audit_field_generic'   => 'Medan',
'profile_audit_change_generic'  => 'Perubahan',
'profile_audit_value_recorded'  => 'Direkodkan',
'profile_audit_value_updated'   => 'Dikemas kini',
'profile_audit_change_recorded' => 'Perubahan direkodkan',
'profile_audit_value_hidden'    => 'Disembunyikan',
'profile_audit_invalid_event_id'=> 'ID acara audit tidak sah.',
'profile_audit_event_not_found' => 'Acara audit tidak ditemui.',
'profile_audit_server_error'    => 'Ralat pelayan semasa mendapatkan maklumat audit.',
...
'userList_page_intro'            => 'Urus identiti pengguna, kumpulan, tahap akses dan peranan tambahan mengikut kategori akaun.',
...
'userList_ajax_method_not_allowed' => 'Kaedah permintaan tidak dibenarkan.',
'userList_validation_required_public' => 'Sila lengkapkan semua maklumat wajib dan pastikan emel serta kata laluan adalah sah.',
'userList_validation_required_access' => 'Sila lengkapkan maklumat pengguna dan tetapan akses sebelum menyimpan.',
'userList_ajax_staff_scope_only' => 'Aliran tambah pengguna ini khusus untuk staf sahaja.',
'userList_ajax_student_scope_only' => 'Aliran tambah pengguna ini khusus untuk pelajar sahaja.',
'userList_ajax_public_scope_only' => 'Aliran tambah pengguna ini khusus untuk pengguna umum sahaja.',
'userList_ajax_employee_no_required' => 'No. pekerja tidak boleh kosong.',
'userList_ajax_matric_required' => 'No. matrik tidak boleh kosong.',
'userList_ajax_invalid_staff_group' => 'Kumpulan yang dipilih tidak sah untuk akses staf.',
'userList_ajax_invalid_student_group' => 'Kumpulan yang dipilih tidak sah untuk akses pelajar.',
'userList_ajax_employee_exists' => 'Pengguna dengan no. pekerja ini sudah wujud dalam sistem.',
'userList_ajax_student_exists' => 'Pelajar dengan nombor matrik ini sudah wujud dalam sistem.',
'userList_ajax_staff_source_not_found' => 'Staf tidak ditemui dalam sumber data atau tidak aktif.',
'userList_ajax_student_source_not_found' => 'Pelajar tidak ditemui dalam sumber data atau tidak aktif.',
'userList_ajax_invalid_matric' => 'No. matrik tidak sah.',
'userList_ajax_student_not_found' => 'Pelajar tidak ditemui.',
'userList_ajax_load_staff_error' => 'Ralat sistem semasa memuatkan senarai staf.',
'userList_ajax_search_staff_error' => 'Ralat sistem semasa mencari staf.',
'userList_ajax_success_add_public' => 'Pengguna umum berjaya ditambah.',
'userList_ajax_database_error' => 'Ralat pangkalan data semasa memproses pengguna.',
'userList_ajax_add_system_error' => 'Ralat sistem semasa menambah pengguna.',
'userList_ajax_add_student_system_error' => 'Ralat sistem semasa menambah pelajar.',
'userList_ajax_add_public_system_error' => 'Ralat sistem semasa menambah pengguna umum.',
...
'userList_ajax_group_assign_denied' => 'Anda tidak dibenarkan menetapkan pengguna kepada kumpulan ini.',
'userList_ajax_user_edit_denied' => 'Anda tidak dibenarkan mengemas kini pengguna ini.',
...
'userGroup_done'                    => 'Berjaya',
'userGroup_group_create_success'    => 'Kumpulan berjaya ditambah.',
'userGroup_group_update_success'    => 'Kumpulan berjaya dikemas kini.',
'userGroup_loading_access'          => 'Memuatkan akses...',
'userGroup_loading_menu'            => 'Memuatkan menu...',
'userGroup_color_picker_title'      => 'Pilih warna kumpulan',
...
// Ruang kerja Matriks Akses profesional
'access_matrix_title' => 'Matriks Akses',
'access_matrix_breadcrumb_home' => 'Papan Pemuka',
'access_matrix_eyebrow' => 'Semakan Akses Super Admin',
'access_matrix_hero_title' => 'Fahami akses bagi setiap menu sistem',
'access_matrix_hero_text' => 'Semak katalog menu lengkap dan bandingkan kebenaran kumpulan melalui satu ruang kerja terkawal.',
'access_matrix_readonly_title' => 'Paparan baca sahaja',
'access_matrix_readonly_text' => 'Perubahan akses diuruskan melalui Kumpulan Pengguna.',
'access_matrix_summary_label' => 'Ringkasan akses',
'access_matrix_kpi_groups' => 'Kumpulan pengguna',
'access_matrix_kpi_modules' => 'Modul',
'access_matrix_kpi_menus' => 'Menu sistem',
'access_matrix_kpi_permissions' => 'Pemetaan akses',
'access_matrix_workspace_eyebrow' => 'Peneroka Kebenaran',
'access_matrix_workspace_title' => 'Matriks Akses Sistem',
'access_matrix_workspace_text' => 'Cari dan tapis secara lokal tanpa memuatkan semula halaman.',
'access_matrix_legend' => 'Petunjuk',
'access_matrix_has_access' => 'Ada akses',
'access_matrix_no_access' => 'Tiada akses',
'access_matrix_search_label' => 'Cari menu atau laluan',
'access_matrix_search_placeholder' => 'Taip nama menu atau laluan...',
'access_matrix_module_filter' => 'Modul',
'access_matrix_all_modules' => 'Semua modul',
'access_matrix_group_filter' => 'Kumpulan pengguna',
'access_matrix_all_groups' => 'Semua kumpulan',
'access_matrix_status_filter' => 'Status akses',
'access_matrix_all_statuses' => 'Semua status',
'access_matrix_reset' => 'Tetapkan semula',
'access_matrix_result_count' => '%d menu dipaparkan',
'access_matrix_scroll_hint' => 'Skrol secara mendatar untuk membandingkan kumpulan',
'access_matrix_error_title' => 'Matriks akses tidak dapat dimuatkan',
'access_matrix_error_text' => 'Sila muat semula halaman atau cuba lagi kemudian.',
'access_matrix_empty_title' => 'Tiada data akses tersedia',
'access_matrix_empty_text' => 'Tiada modul, menu atau kumpulan pengguna tersedia pada masa ini.',
'access_matrix_table_label' => 'Jadual matriks akses sistem',
'access_matrix_menu_column' => 'Menu',
'access_matrix_path_column' => 'Laluan',
'access_matrix_module_menu_count' => '%d menu',
'access_matrix_filter_empty_title' => 'Tiada menu sepadan',
'access_matrix_filter_empty_text' => 'Ubah atau tetapkan semula penapis semasa.',
...
'manual_dt_length_menu' => 'Papar _MENU_ rekod',
...
'manual_dt_paginate_prev' => 'Sebelumnya',
'manual_dt_paginate_next' => 'Seterusnya',
'manual_dt_zero_records' => 'Tiada padanan ditemui',
'manual_dt_search_label' => 'Cari',
...
'manual_table_unavailable' => 'Jadual pangkalan data manual pengguna tidak tersedia. Jalankan migration deployment yang diluluskan.',
'manual_sync_retired' => 'Penyelarasan kumpulan tidak lagi diperlukan. Semua kumpulan dipaparkan secara automatik.',
'manual_view_invalid_request' => 'Permintaan manual tidak sah.',
'manual_view_load_failed' => 'Manual tidak dapat dimuatkan.',
'manual_hero_eyebrow' => 'Dokumentasi Terkawal',
'manual_hero_title' => 'Pastikan setiap kumpulan pengguna menerima panduan yang betul',
'manual_hero_text' => 'Muat naik, gantikan dan semak manual PDF khusus kumpulan melalui satu ruang pengurusan yang selamat.',
'manual_secure_title' => 'Aliran PDF terlindung',
'manual_secure_text' => 'Validasi PDF dikuatkuasakan dengan saiz fail maksimum %dMB.',
'manual_summary_label' => 'Ringkasan liputan manual',
'manual_kpi_groups' => 'Kumpulan pengguna',
'manual_kpi_available' => 'Manual tersedia',
'manual_kpi_missing' => 'Manual belum tersedia',
'manual_kpi_coverage' => 'Liputan',
'manual_list_eyebrow' => 'Pustaka Manual',
'manual_list_title' => 'Liputan Manual Kumpulan',
'manual_list_text' => 'Semak ketersediaan dan urus PDF semasa bagi setiap kumpulan pengguna.',
...
'pageTemplateGenerator_breadcrumb_active' => 'Penjana Template Sistem',
...
'pageTemplateGenerator_btn_preview' => 'Pratonton Output',
'pageTemplateGenerator_btn_generate' => 'Jana Fail',
'pageTemplateGenerator_preview_title' => 'Ringkasan Preview',
'pageTemplateGenerator_preview_subtitle' => 'Semak nama fail dan status pertindihan sebelum penjanaan.',
'pageTemplateGenerator_preview_empty' => 'Belum ada pratonton. Isi borang dan klik Pratonton Output.',
...
'pageTemplateGenerator_governance_title' => 'Senarai Semak Tadbir Urus',
'pageTemplateGenerator_governance_text' => 'Halaman yang dijana mesti selari dengan kunci bahasa, pendaftaran akses dan rekod audit sebelum digunakan dalam persekitaran produksi.',
'pageTemplateGenerator_governance_language' => 'Kunci bahasa',
'pageTemplateGenerator_governance_audit' => 'Rekod audit',
...
'pageTemplateGenerator_error_permission' => 'Hanya Super Admin boleh mengakses penjana template sistem.',
'pageTemplateGenerator_error_bootstrap' => 'Penjana template tidak dapat dimuatkan. Sila hubungi pentadbir sistem.',
'pageTemplateGenerator_error_invalid_action' => 'Tindakan penjana yang diminta tidak sah.',
'pageTemplateGenerator_error_slug_exists' => 'Rekod template untuk slug halaman ini sudah wujud.',
'pageTemplateGenerator_error_controller_exists' => 'Rekod template untuk kelas controller ini sudah wujud.',
'pageTemplateGenerator_validation_too_long' => 'Nilai ini melebihi panjang yang dibenarkan.',
'pageTemplateGenerator_validation_icon' => 'Sila pilih ikon halaman yang sah.',
'pageTemplateGenerator_eyebrow' => 'Ruang Kerja Pembangun',
'pageTemplateGenerator_hero_title' => 'Bina halaman terkawal dengan yakin',
'pageTemplateGenerator_hero_subtitle' => 'Cipta asas halaman yang konsisten, sahkan setiap output dan simpan rekod penjanaan yang jelas.',
'pageTemplateGenerator_summary_label' => 'Ringkasan template',
'pageTemplateGenerator_metric_total' => 'Jumlah template',
'pageTemplateGenerator_metric_generated' => 'Sedia',
'pageTemplateGenerator_metric_archived' => 'Diarkibkan',
'pageTemplateGenerator_super_admin_note' => 'Dikawal oleh Super Admin',
'pageTemplateGenerator_step_identity' => 'Maklumat halaman',
'pageTemplateGenerator_step_branding' => 'Pemilihan ikon',
'pageTemplateGenerator_step_access' => 'Polisi akses',
'pageTemplateGenerator_detail_overview' => 'Aset yang dijana',
'pageTemplateGenerator_detail_created_by' => 'Dijana oleh',
'pageTemplateGenerator_detail_outputs' => 'Fail output',
'pageTemplateGenerator_btn_copy' => 'Salin path',
'pageTemplateGenerator_copy_success' => 'Path berjaya disalin',
'pageTemplateGenerator_copy_failed' => 'Path tidak dapat disalin',
...
'notification_hero_eyebrow' => 'PUSAT NOTIFIKASI PERIBADI',
'notification_hero_title' => 'Kekal peka dan bertindak dengan yakin',
'notification_hero_text' => 'Semak kemas kini sistem, pengumuman dan tugasan untuk akaun anda dalam satu ruang kerja yang tersusun.',
'notification_private_title' => 'Khusus untuk akaun anda',
'notification_private_text' => 'Hanya notifikasi yang boleh dilihat oleh identiti aktif dan kumpulan akses anda dipaparkan.',
'notification_summary_label' => 'Ringkasan notifikasi',
'notification_kpi_total' => 'Jumlah',
'notification_kpi_unread' => 'Belum dibaca',
'notification_kpi_action' => 'Perlu tindakan',
'notification_kpi_overdue' => 'Lewat',
'notification_workspace_eyebrow' => 'PETI MASUK ANDA',
'notification_workspace_title' => 'Ruang kerja notifikasi',
'notification_workspace_text' => 'Tapis, cari dan semak mesej tanpa meninggalkan halaman ini.',
'notification_filter_label' => 'Penapis notifikasi',
'notification_search_label' => 'Cari notifikasi',
'notification_search_placeholder' => 'Cari tajuk atau mesej...',
'notification_loading_local' => 'Memuatkan notifikasi...',
'notification_empty_title' => 'Peti masuk anda kosong',
'notification_empty_text' => 'Tiada notifikasi sepadan dengan penapis atau carian semasa.',
'notification_error_title' => 'Notifikasi tidak dapat dimuatkan',
'notification_retry' => 'Cuba lagi',
'notification_open' => 'Buka',
'notification_mark_read' => 'Tanda dibaca',
'notification_read_all_busy' => 'Mengemas kini...',
'notification_page_label' => 'Halaman {page} daripada {pages}',
'notification_results_label' => 'Memaparkan {start}–{end} daripada {total} notifikasi',
'notification_pagination_label' => 'Halaman notifikasi',
'notification_previous' => 'Sebelumnya',
'notification_next' => 'Seterusnya',
'notification_rate_limited' => 'Terlalu banyak permintaan. Sila cuba sebentar lagi.',
'notification_admin_page_title' => 'Admin Notifikasi',
'notification_admin_hero_eyebrow' => 'KOMUNIKASI TERKAWAL',
'notification_admin_hero_title' => 'Terbitkan mesej yang tepat kepada penerima yang betul',
'notification_admin_hero_text' => 'Cipta, sasarkan dan semak notifikasi sistem melalui satu ruang pentadbiran yang terkawal.',
'notification_admin_hero_note_title' => 'Penerbitan melibatkan pengguna sebenar',
'notification_admin_hero_note_text' => 'Semak penerima dan pratonton sebelum mengesahkan penerbitan.',
'notification_admin_summary_label' => 'Ringkasan penerbitan notifikasi',
'notification_admin_target_count' => 'Jumlah sasaran',
'notification_admin_no_audience' => 'Tiada penerima',
'notification_admin_more' => 'lagi',
'notification_admin_rules' => 'peraturan',
'notification_admin_status' => 'Status',
'notification_admin_inactive' => 'Tidak aktif',
'notification_admin_filter_label' => 'Penapis notifikasi',
'notification_admin_list_failed' => 'Rekod notifikasi tidak dapat dimuatkan.',
'notification_admin_tab_setup' => 'Tetapan Notifikasi',
'notification_admin_tab_basic' => 'Asas',
'notification_admin_tab_content' => 'Kandungan',
'notification_admin_tab_audience' => 'Penerima',
'notification_admin_tab_action' => 'Tindakan & Jadual',
'notification_admin_audience_all_users' => 'Semua pengguna',
'notification_admin_confirm_title_label' => 'Tajuk',
'notification_admin_confirm_audience_label' => 'Penerima',
'notification_admin_confirm_type_label' => 'Jenis / Keutamaan',
'notification_admin_confirm_schedule_label' => 'Tarikh luput',
'notification_admin_no_expiry' => 'Tiada tarikh luput',
'notification_admin_confirm_title' => 'Sahkan penerbitan notifikasi',
'notification_admin_confirm_text' => 'Semak butiran penerbitan sebelum meneruskan.',
'notification_admin_confirm_broadcast_title' => 'Sahkan hebahan kepada semua pengguna',
'notification_admin_confirm_broadcast_text' => 'Notifikasi ini akan dipaparkan kepada semua pengguna yang layak.',
'notification_admin_confirm_publish' => 'Ya, terbitkan',
'notification_admin_validation_title' => 'Tajuk notifikasi wajib diisi.',
'notification_admin_validation_title_length' => 'Tajuk tidak boleh melebihi 255 aksara.',
'notification_admin_validation_body_length' => 'Kandungan notifikasi tidak boleh melebihi 10,000 aksara.',
'notification_admin_validation_audience' => 'Penerima yang sah diperlukan.',
'notification_admin_validation_datetime' => 'Satu atau lebih nilai tarikh tidak sah.',
'notification_admin_validation_schedule' => 'Tarikh luput mestilah selepas tarikh mula.',
'notification_admin_validation_due_action' => 'Aktifkan tindakan pengguna apabila tarikh akhir diberikan.',
'notification_admin_validation_due_expiry' => 'Tarikh akhir tindakan tidak boleh selepas tarikh luput.',
'notification_admin_validation_audience_limit' => 'Penerima dihadkan kepada 500 nilai bagi setiap penerbitan.',
'notification_admin_validation_audience_value' => 'Salah satu nilai penerima terlalu panjang.',
'notification_admin_validation_action_url' => 'URL tindakan mestilah path dalaman aplikasi yang selamat.',
'notification_admin_example_prefix' => 'Contoh:',
'notification_admin_copied' => 'Disalin',
'notification_admin_copy' => 'Salin',
'notification_admin_sample' => 'Contoh',
'common_dashboard' => 'Papan Pemuka',
'notification_admin_samples_button' => 'Contoh Pembangun',
'notification_admin_samples_title' => 'Contoh Notifikasi untuk Pembangun',
'notification_admin_samples_subtitle' => 'Salin contoh notifikasi aliran kerja standard untuk integrasi modul.',
'notification_admin_help_event_code' => 'Kod rujukan dalaman untuk penjejakan. Sistem akan menjana kod jika dibiarkan kosong.',
'notification_admin_help_template' => 'Pilih templat untuk mengisi kandungan, ikon dan tetapan asas secara automatik.',
'notification_admin_help_type' => 'Pilih fungsi notifikasi: hebahan, peringatan, acara atau tugasan aliran kerja.',
'notification_admin_help_severity' => 'Menentukan penekanan visual dan tahap kecemasan kepada pengguna.',
'notification_admin_help_priority' => 'Keutamaan digunakan untuk susunan dan penekanan notifikasi.',
'notification_admin_help_dedupe_key' => 'Gunakan kunci unik jika notifikasi yang sama tidak sepatutnya digandakan.',
'notification_admin_help_dedupe_behavior' => 'Kemas kini mengubah rekod sedia ada, langkau mengabaikan pendua dan terbit semula mencipta rekod baharu.',
'notification_admin_help_title_ms' => 'Tajuk utama Bahasa Melayu yang dipaparkan kepada pengguna. Medan ini wajib.',
'notification_admin_help_title_en' => 'Tajuk Bahasa Inggeris. Tajuk Bahasa Melayu digunakan jika medan ini kosong.',
'notification_admin_help_body_ms' => 'Tulis mesej Bahasa Melayu yang ringkas dan jelas untuk panel notifikasi.',
'notification_admin_help_body_en' => 'Sediakan mesej Bahasa Inggeris untuk mod paparan Bahasa Inggeris.',
'notification_admin_help_audience_type' => 'Pilih penerima notifikasi. Gunakan ALL untuk semua pengguna yang layak.',
'notification_admin_help_group_picker' => 'Pilih kumpulan dengan pantas dan isikan ID kumpulannya.',
'notification_admin_help_category_picker' => 'Sasarkan kategori pengguna seperti STAF, PELAJAR atau UMUM dengan pantas.',
'notification_admin_help_action_url' => 'Gunakan path dalaman aplikasi sahaja, contohnya pages/profile.php.',
'notification_admin_help_action_label_ms' => 'Teks butang tindakan Bahasa Melayu, contohnya Semak Sekarang.',
'notification_admin_help_action_label_en' => 'Teks butang tindakan Bahasa Inggeris, contohnya Review Now.',
'notification_admin_help_due_at' => 'Tarikh akhir tindakan pengguna. Biarkan kosong jika tiada tarikh akhir.',
'notification_admin_help_expires_at' => 'Tarikh dan masa notifikasi berhenti dipaparkan.',
'notification_admin_help_icon' => 'Pilih ikon yang menggambarkan jenis mesej.',
'notification_admin_help_requires_action' => 'Aktifkan apabila pengguna perlu menyelesaikan atau mengakui sesuatu tugasan.',
'common_yes' => 'Ya',
'common_no' => 'Tidak',
'common_cancel' => 'Batal',
'common_close' => 'Tutup',
...
'notification_admin_stat_broadcast' => 'Hebahan Menyeluruh',
'notification_admin_composer_title' => 'Terbit Notifikasi',
'notification_admin_composer_subtitle' => 'Cipta notifikasi sistem, peringatan atau aliran kerja untuk penerima terpilih.',
'notification_admin_event_code' => 'Kod Acara',
'notification_admin_template' => 'Template',
'notification_admin_no_template' => 'Tiada templat',
'notification_admin_type' => 'Jenis',
'notification_admin_severity' => 'Tahap',
'notification_admin_priority' => 'Keutamaan',
...
'notification_admin_audience_type' => 'Penerima',
'notification_admin_audience_value' => 'Nilai Penerima',
...
'notification_admin_reset' => 'Tetapkan Semula',
'notification_admin_publish' => 'Terbit',
'notification_admin_preview_title' => 'Pratonton',
...
'notification_template_hero_eyebrow' => 'KOMUNIKASI BOLEH GUNA SEMULA',
'notification_template_hero_title' => 'Bina notifikasi konsisten sekali, gunakan semula di mana-mana',
'notification_template_hero_text' => 'Urus kandungan dwibahasa terkawal untuk modul, penjadual dan eskalasi aliran kerja.',
'notification_template_hero_note_title' => 'Templat sedia untuk pembangun',
'notification_template_hero_note_text' => 'Kod templat dan acara menghubungkan aliran aplikasi kepada mesej boleh guna semula.',
'notification_template_summary_label' => 'Ringkasan templat',
'notification_template_tab_basic' => 'Asas',
'notification_template_tab_content' => 'Kandungan',
'notification_template_tab_action' => 'Tindakan & Ikon',
'notification_template_tab_advanced' => 'Lanjutan',
'notification_template_action_badge' => 'Tindakan',
'notification_template_used_by' => 'Digunakan oleh {count} notifikasi',
'notification_template_in_use_help' => 'Templat sedang digunakan. Arkibkan templat ini sebagai gantinya.',
'notification_template_not_found' => 'Templat notifikasi tidak ditemukan.',
'notification_template_action_confirm' => 'Sahkan tindakan terhadap templat ini?',
'notification_template_confirm' => 'Sahkan',
'notification_template_done' => 'Selesai.',
'notification_template_action_failed' => 'Tindakan terhadap templat gagal.',
'notification_template_list_failed' => 'Templat notifikasi tidak dapat dimuatkan.',
'notification_template_validation_required' => 'Kod templat, kod acara dan tajuk Bahasa Melayu wajib diisi.',
'notification_template_validation_body_length' => 'Kandungan templat tidak boleh melebihi 10,000 aksara.',
'notification_template_validation_unique' => 'Kod templat dan kod acara mestilah unik.',
'notification_template_validation_json' => 'Placeholder mestilah JSON yang sah.',
'notification_template_validation_json_object' => 'Placeholder mestilah objek JSON dengan maksimum 100 entri.',
'notification_template_help_template_code' => 'Kod templat unik, contohnya CORE_PASSWORD_REMINDER.',
'notification_template_help_event_code' => 'Kod acara yang digunakan oleh kod aplikasi semasa menerbitkan notifikasi.',
'notification_template_help_module_code' => 'Kod modul pemilik, contohnya CORE, HR atau FACILITY.',
'notification_template_help_type' => 'Jenis notifikasi lalai yang digunakan oleh templat ini.',
'notification_template_help_category' => 'Kategori ringkas seperti system atau approval.',
'notification_template_help_severity' => 'Menentukan tahap visual dan kecemasan notifikasi.',
'notification_template_help_priority' => 'Menentukan susunan dan penekanan kepada pengguna.',
'notification_template_help_title_ms' => 'Tajuk Bahasa Melayu yang dipaparkan kepada pengguna.',
'notification_template_help_title_en' => 'Tajuk Bahasa Inggeris untuk mod Bahasa Inggeris.',
'notification_template_help_body_ms' => 'Mesej Bahasa Melayu yang boleh mengandungi placeholder.',
'notification_template_help_body_en' => 'Mesej Bahasa Inggeris jika diperlukan.',
'notification_template_help_action_label_ms' => 'Label butang tindakan Bahasa Melayu.',
'notification_template_help_action_label_en' => 'Label butang tindakan Bahasa Inggeris.',
'notification_template_help_icon' => 'Ikon lalai untuk templat ini.',
'notification_template_help_placeholders' => 'Objek JSON yang menerangkan pemboleh ubah yang diterima templat.',
'notification_template_help_requires_action' => 'Aktifkan jika templat ini biasanya memerlukan tindakan pengguna.',
'notification_template_help_status' => 'Hanya templat aktif boleh dipilih untuk penerbitan.',
'notification_icon_general' => 'Notifikasi umum',
'notification_icon_announcement' => 'Hebahan',
'notification_icon_warning' => 'Amaran penting',
'notification_icon_reminder' => 'Peringatan / tarikh akhir',
'notification_icon_workflow' => 'Tugasan aliran kerja',
'notification_icon_success' => 'Berjaya / diluluskan',
'notification_icon_issue' => 'Isu / ditolak',
'notification_icon_security' => 'Keselamatan',
'notification_icon_account' => 'Akaun pengguna',
'notification_icon_document' => 'Dokumen / borang',
'systemCache_page_title' => 'Cache Sistem',
'systemCache_breadcrumb_active' => 'Pembersihan Cache',
...
'systemCache_action_clear_selected' => 'Bersihkan Pilihan',
'systemCache_action_clear_all' => 'Bersihkan Semua Cache',
...
'systemCache_confirm_title' => 'Bersihkan Cache Sistem?',
'systemCache_confirm_text' => 'Tindakan ini akan membuang fail cache yang ditemui dan menetapkan semula cache PHP.',
'systemCache_confirm_cancel' => 'Batal',
'systemCache_confirm_clear' => 'Bersihkan Cache',
'systemCache_success_title' => 'Cache Dibersihkan',
'systemCache_success_message' => 'Cache sistem berjaya dibersihkan.',
'systemCache_success_note' => 'Pengguna tidak perlu log keluar dan masuk semula selepas cache dibersihkan. Muat semula halaman biasanya mencukupi.',
...
'systemCache_error_invalid_method' => 'Kaedah permintaan tidak sah.',
...
'systemCache_eyebrow' => 'Penyelenggaraan Super Admin',
'systemCache_hero_title' => 'Pastikan cache sistem sihat dan terkawal',
'systemCache_hero_subtitle' => 'Semak lokasi cache yang ditemui dan lakukan pembersihan terkawal tanpa membuang struktur direktori.',
'systemCache_risk_title' => 'Operasi sensitif',
'systemCache_risk_text' => 'Pembersihan semua cache turut menetapkan semula cache runtime PHP yang tersedia.',
'systemCache_state_enabled' => 'Diaktifkan',
'systemCache_state_disabled' => 'Dinyahaktifkan',
'systemCache_state_unavailable' => 'Tidak tersedia',
'systemCache_selected_none' => 'Tiada lokasi dipilih',
'systemCache_selected_one' => '1 lokasi dipilih',
'systemCache_selected_many' => '{count} lokasi dipilih',
'systemCache_select_all' => 'Pilih semua lokasi cache',
'systemCache_select_location' => 'Pilih lokasi cache',
'systemCache_location_standard' => 'Cache standard projek',
'systemCache_confirm_selected_text' => 'Lokasi cache yang dipilih akan dibersihkan.',
'systemCache_confirm_all_text' => 'Semua lokasi cache yang ditemui, OPcache dan APCu akan dibersihkan.',
'systemCache_partial_title' => 'Cache dibersihkan sebahagian',
'systemCache_result_errors' => 'Item yang gagal dibersihkan',
'systemCache_error_invalid_scope' => 'Skop cache tidak sah.',
'systemCache_error_invalid_location' => 'Tiada lokasi cache sah dipilih.',
'systemCache_error_busy' => 'Operasi penyelenggaraan cache lain sedang berjalan.',
'systemCache_action_close' => 'Tutup',
...
// Tetapan sistem — shell, keselamatan dan AI Chatbot
'config_page_intro' => 'Urus konfigurasi teras, keselamatan, integrasi dan pengalaman sistem dari satu ruang kerja.',
'config_page_global_notice' => 'Perubahan pada halaman ini boleh memberi kesan kepada semua pengguna dan servis sistem.',
'config_rate_limit_title' => 'Terlalu Banyak Permintaan',
'config_rate_limit_text' => 'Terlalu banyak permintaan. Sila cuba lagi sebentar.',
'config_invalid_request_title' => 'Ralat Permintaan',
'config_invalid_request_text' => 'Permintaan tetapan sistem tidak sah.',
'config_json_response_error' => 'Respons sistem tidak dapat dijana.',
'config_method_not_allowed' => 'Kaedah permintaan tidak dibenarkan.',
'config_security_error_title' => 'Ralat Keselamatan',
'config_csrf_invalid_text' => 'CSRF token tidak sah. Sila muat semula halaman dan cuba lagi.',
'config_access_denied_title' => 'Akses Ditolak',
'config_login_required_text' => 'Sila log masuk terlebih dahulu.',
'config_super_admin_only_text' => 'Hanya Super Admin dibenarkan mengakses halaman Konfigurasi Sistem.',
'config_js_emel_uji_error_safe' => 'Ujian sambungan emel gagal. Sila semak konfigurasi atau log sistem.',
'config_ai_chatbot_validation_title' => 'Ralat Validasi',
'config_ai_chatbot_success_title' => 'Berjaya',
'config_ai_chatbot_success_text' => 'Tetapan AI Chatbot berjaya disimpan.',
'config_ai_chatbot_success_text_summary' => 'Tetapan AI Chatbot berjaya disimpan. Perubahan: %s.',
'config_ai_chatbot_save_error_title' => 'Ralat Menyimpan',
'config_ai_chatbot_save_error_text' => 'Gagal menyimpan tetapan AI Chatbot. Sila cuba lagi atau hubungi pentadbir sistem.',
'config_ai_chatbot_system_error_title' => 'Ralat Sistem',
'config_ai_chatbot_system_error_text' => 'Ralat berlaku semasa menyimpan tetapan AI Chatbot. Sila semak log sistem untuk maklumat lanjut.',

// Pusat Audit
'audit_center_page_title' => 'Pusat Audit',
'audit_center_breadcrumb_dashboard' => 'Papan Pemuka',
'audit_center_access_denied_title' => 'Akses Ditolak',
'audit_center_access_denied_text' => 'Pusat Audit hanya boleh diakses oleh Super Admin.',
'audit_center_hero_eyebrow' => 'Pemantauan Audit',
'audit_center_hero_title' => 'Ruang Kerja Operasi Audit',
'audit_center_hero_text' => 'Semak aktiviti, permintaan, sesi, perubahan dan isyarat keselamatan dari satu ruang kerja terkawal.',
'audit_center_chip_ajax' => 'Data Langsung',
'audit_center_chip_live_paging' => 'Paging Pelayan',
'audit_center_chip_super_admin' => 'Super Admin',
'audit_center_nav_title' => 'Paparan Audit',
'audit_center_tab_events' => 'Peristiwa',
'audit_center_tab_requests' => 'Permintaan',
'audit_center_tab_sessions' => 'Sesi',
'audit_center_tab_changes' => 'Perubahan',
'audit_center_tab_security' => 'Keselamatan',
'audit_center_loading_summary' => 'Memuatkan ringkasan audit...',
'audit_center_loading_panel' => 'Memuatkan data audit...',
'audit_center_load_failed' => 'Data Pusat Audit gagal dimuatkan. Sila cuba semula.',
'audit_center_filter_search' => 'Carian',
'audit_center_filter_search_placeholder' => 'Cari ID log masuk, route, ID permintaan, IP atau pelaku',
'audit_center_filter_limit' => 'Had',
'audit_center_filter_advanced_toggle' => 'Lanjutan',
'audit_center_filter_reset' => 'Tetapkan Semula',
'audit_center_filter_apply' => 'Gunakan Penapis',
'audit_center_filter_date_from' => 'Tarikh Mula',
'audit_center_filter_date_to' => 'Tarikh Akhir',
'audit_center_filter_event_type' => 'Jenis Peristiwa',
'audit_center_export_csv' => 'Eksport CSV',
'audit_center_export_json' => 'Eksport JSON',
'audit_center_export_rate_limited' => 'Terlalu banyak permintaan eksport. Sila tunggu sebentar.',
'audit_center_panel_rate_limited' => 'Terlalu banyak permintaan Pusat Audit. Sila tunggu sebentar.',
'audit_center_summary_events_today' => 'Peristiwa Hari Ini',
'audit_center_summary_security_today' => 'Keselamatan Hari Ini',
'audit_center_summary_active_sessions' => 'Sesi Aktif',
'audit_center_summary_active_lockouts' => 'Sekatan Aktif',
'audit_center_summary_active_throttles' => 'Pendikitan Aktif',
'audit_center_events_title' => 'Peristiwa Terkini',
'audit_center_requests_title' => 'Jejak Permintaan',
'audit_center_sessions_title' => 'Aktiviti Sesi',
'audit_center_changes_title' => 'Penjejakan Perubahan',
'audit_center_security_events_title' => 'Peristiwa Keselamatan Terkini',
'audit_center_security_lockouts_title' => 'Sekatan Aktif',
'audit_center_security_throttles_title' => 'Pendikitan Aktif',
'audit_center_page_label' => 'Halaman',
'audit_center_page_of' => 'daripada',
'audit_center_pager_total' => 'Jumlah',
'audit_center_pager_records' => 'rekod',
'audit_center_pager_prev' => 'Sebelumnya',
'audit_center_pager_next' => 'Seterusnya',
'audit_center_action_view_metadata' => 'Lihat Metadata',
'audit_center_action_clear_lockout' => 'Bersihkan Sekatan',
'audit_center_action_clear_throttle' => 'Bersihkan Pendikitan',
'audit_center_action_terminate_session' => 'Tamatkan Sesi',
'audit_center_action_confirm_button' => 'Teruskan',
'audit_center_action_cancel_button' => 'Batal',
'audit_center_action_success_title' => 'Tindakan Berjaya',
'audit_center_action_error_title' => 'Tindakan Gagal',
'audit_center_action_ok_button' => 'OK',
'audit_center_action_clear_lockout_title' => 'Bersihkan sekatan ini?',
'audit_center_action_clear_lockout_text' => 'Sekatan aktif untuk ID log masuk ini akan dibersihkan serta-merta.',
'audit_center_action_clear_throttle_title' => 'Bersihkan pendikitan ini?',
'audit_center_action_clear_throttle_text' => 'Pendikitan aktif untuk skop ini akan dibersihkan serta-merta.',
'audit_center_action_terminate_session_title' => 'Tamatkan sesi ini?',
'audit_center_action_terminate_session_text' => 'Sesi ini akan ditamatkan serta-merta dan pengguna perlu log masuk semula.',
'audit_center_action_rate_limited' => 'Terlalu banyak tindakan. Sila tunggu sebentar.',
'audit_center_action_server_error' => 'Ralat sistem berlaku semasa memproses tindakan Pusat Audit.',
'audit_center_meta_modal_title' => 'Paparan Metadata Audit',
'audit_center_meta_close_button' => 'Tutup',
'audit_center_meta_loading_title' => 'Memuatkan Metadata',
'audit_center_meta_loading_text' => 'Sila tunggu sementara metadata audit dimuatkan.',
'audit_center_meta_section_raw_record' => 'Rekod Mentah',
'audit_center_meta_section_fallback' => 'Seksyen',
'audit_center_meta_copy_button' => 'Salin JSON',
'audit_center_meta_copy_success' => 'JSON berjaya disalin',
'audit_center_meta_empty' => 'Tiada metadata tambahan direkodkan untuk item ini.',
'audit_center_meta_rate_limited' => 'Terlalu banyak permintaan metadata. Sila tunggu sebentar.',
'audit_center_meta_invalid_kind' => 'Jenis metadata tidak sah.',
'audit_center_meta_not_found' => 'Rekod metadata tidak ditemui.',
'audit_center_meta_server_error' => 'Ralat sistem berlaku semasa memuatkan metadata audit.',
'audit_center_meta_title_event' => 'Metadata Peristiwa',
'audit_center_meta_title_request' => 'Metadata Permintaan',
'audit_center_meta_title_session' => 'Metadata Sesi',
'audit_center_meta_title_change' => 'Metadata Set Perubahan',
'audit_center_meta_title_lockout' => 'Metadata Sekatan',
'audit_center_meta_title_throttle' => 'Metadata Pendikitan',
'audit_center_meta_section_event_meta' => 'Metadata Peristiwa',
'audit_center_meta_section_change_sets' => 'Set Perubahan Berkaitan',
'audit_center_meta_section_related_events' => 'Peristiwa Berkaitan',
'audit_center_meta_section_change_meta' => 'Metadata Set Perubahan',
'audit_center_meta_section_field_changes' => 'Perubahan Medan',
'audit_center_detail_masked' => '[DISAMARKAN]',
'audit_center_detail_yes' => 'Ya',
'audit_center_detail_no' => 'Tidak',
'audit_center_detail_old_value' => 'Nilai Lama',
'audit_center_detail_new_value' => 'Nilai Baharu',
'audit_center_detail_sensitive' => 'Sensitif',
'audit_center_detail_field' => 'Medan',
'audit_center_detail_data_type' => 'Jenis Data',
'audit_center_detail_empty' => 'Tiada butiran tambahan.',
'audit_center_col_actor' => 'Pelaku',
'audit_center_col_event' => 'Peristiwa',
'audit_center_col_outcome' => 'Keputusan',
'audit_center_col_status' => 'Status',
'audit_center_col_user' => 'Pengguna',
'audit_center_col_route' => 'Route',
'audit_center_col_method' => 'Kaedah',
'audit_center_col_duration' => 'Tempoh',
'audit_center_col_target' => 'Sasaran',
'audit_center_col_reason' => 'Sebab',
'audit_center_col_fields' => 'Medan',
'audit_center_col_attempts' => 'Cubaan',
'audit_center_col_scope' => 'Skop',
'audit_center_col_scope_key' => 'Kunci Skop',
'audit_center_action_invalid_payload' => 'Data tindakan tidak sah.',
'audit_center_action_method_not_allowed' => 'Kaedah permintaan tidak dibenarkan.',
'audit_center_action_invalid_type' => 'Jenis tindakan tidak sah.',
'audit_center_action_lockout_missing' => 'ID log masuk untuk sekatan tidak diberikan.',
'audit_center_action_lockout_failed' => 'Sekatan tersebut gagal dibersihkan.',
'audit_center_action_lockout_cleared' => 'Sekatan berjaya dibersihkan.',
'audit_center_action_throttle_missing' => 'Maklumat pendikitan tidak lengkap.',
'audit_center_action_throttle_failed' => 'Pendikitan tersebut gagal dibersihkan.',
'audit_center_action_throttle_cleared' => 'Pendikitan berjaya dibersihkan.',
'audit_center_action_session_missing' => 'ID sesi tidak diberikan.',
'audit_center_action_session_current_forbidden' => 'Sesi semasa tidak boleh ditamatkan dari Pusat Audit.',
'audit_center_action_session_failed' => 'Sesi gagal ditamatkan atau telah berakhir.',
'audit_center_action_session_terminated' => 'Sesi berjaya ditamatkan.',
'audit_center_changes_no_fields' => 'Tiada perubahan medan direkodkan.',
'audit_center_detail_diff_hint' => 'Petunjuk Perbezaan',
'audit_center_tab_events_text' => 'Semak peristiwa audit, keputusan, pelaku dan sasaran sistem terkini.',
'audit_center_tab_requests_text' => 'Semak route, kod status dan tempoh pemprosesan permintaan.',
'audit_center_tab_sessions_text' => 'Semak sesi dan peranti aktif serta sejarah audit.',
'audit_center_tab_changes_text' => 'Semak perubahan peringkat medan untuk tujuan forensik.',
'audit_center_tab_security_text' => 'Pantau peristiwa keselamatan, sekatan dan pendikitan aktif.',
'audit_center_summary_events_today_text' => 'Peristiwa audit yang direkodkan hari ini.',
'audit_center_summary_security_today_text' => 'Isyarat pengesahan dan keselamatan yang dikesan hari ini.',
'audit_center_summary_active_sessions_text' => 'Sesi audit yang sedang aktif.',
'audit_center_summary_active_lockouts_text' => 'Sekatan ID log masuk yang aktif.',
'audit_center_summary_active_throttles_text' => 'Pendikitan log masuk dan IP yang aktif.',
'audit_center_detail_login_id' => 'ID Log Masuk', 'audit_center_detail_ip' => 'IP', 'audit_center_detail_severity' => 'Tahap',
'audit_center_detail_target_type' => 'Jenis Sasaran', 'audit_center_col_session_id' => 'ID Sesi', 'audit_center_detail_scope_type' => 'Jenis Skop',
'audit_center_events_empty' => 'Tiada peristiwa audit ditemui.', 'audit_center_col_occurred' => 'Masa Berlaku', 'audit_center_detail_user_id' => 'ID Pengguna',
'audit_center_detail_request_id' => 'ID Permintaan', 'audit_center_detail_session_id' => 'ID Sesi', 'audit_center_detail_target_id' => 'ID Sasaran',
'audit_center_detail_target_label' => 'Label Sasaran', 'audit_center_detail_message' => 'Mesej', 'audit_center_requests_empty' => 'Tiada jejak permintaan ditemui.',
'audit_center_col_started' => 'Masa Mula', 'audit_center_detail_ended_at' => 'Masa Tamat', 'audit_center_detail_route' => 'Route',
'audit_center_sessions_empty' => 'Tiada sesi audit ditemui.', 'audit_center_detail_user' => 'Pengguna', 'audit_center_detail_user_agent' => 'Ejen Pengguna',
'audit_center_detail_legacy_identifier' => 'Pengecam Lama', 'audit_center_changes_empty' => 'Tiada set perubahan ditemui.', 'audit_center_col_changed_at' => 'Masa Perubahan',
'audit_center_detail_change_set_id' => 'ID Set Perubahan', 'audit_center_detail_event_id' => 'ID Peristiwa', 'audit_center_detail_actor' => 'Pelaku',
'audit_center_detail_event_type' => 'Jenis Peristiwa', 'audit_center_detail_change_reason' => 'Sebab Perubahan',
'audit_center_security_events_empty' => 'Tiada peristiwa keselamatan ditemui.', 'audit_center_security_lockouts_empty' => 'Tiada sekatan aktif ditemui.',
'audit_center_col_locked_until' => 'Disekat Sehingga', 'audit_center_detail_last_failed_at' => 'Kegagalan Terakhir',
'audit_center_security_throttles_empty' => 'Tiada pendikitan aktif ditemui.',
'emailTemplate_governance_title' => 'Kandungan emel terkawal',
'emailTemplate_governance_text' => 'Pratonton placeholder dan sahkan penerima sebelum menghantar.',
'emailTemplate_unsaved_indicator' => 'Perubahan belum disimpan',
'emailTemplate_unsaved_confirm_title' => 'Buang perubahan belum disimpan?',
'emailTemplate_unsaved_confirm_text' => 'Perubahan pada template ini masih belum disimpan.',
'emailTemplate_unsaved_confirm_discard' => 'Buang perubahan',
'emailTemplate_test_confirm_title' => 'Hantar emel ujian?',
'emailTemplate_test_confirm_text' => 'Sahkan penerima dan subjek sebelum menghantar.',
'emailTemplate_test_confirm_button' => 'Hantar emel ujian',
'emailTemplate_test_recipient_label' => 'Penerima',
'emailTemplate_test_subject_label' => 'Subjek',
'emailTemplate_external_resource_warning' => 'Imej atau pautan luar mungkin menghubungi pelayan pihak ketiga apabila penerima membuka emel.',
'emailTemplate_error_bootstrap' => 'Pengurusan template emel tidak dapat dimuatkan buat masa ini.',
];
