...
'config_ai_chatbot_core_settings' => 'Tetapan Core AI Chatbot',
'config_ai_chatbot_enable' => 'Aktifkan AI Chatbot',
'config_ai_chatbot_access_mode' => 'Mod Akses',
'config_ai_chatbot_allowed_groups' => 'Kumpulan Dibenarkan',
'config_ai_chatbot_provider' => 'Provider',
'config_ai_chatbot_model' => 'Model',
'config_ai_chatbot_model_placeholder' => 'Pilih model',
'config_ai_chatbot_model_status_fetch' => 'Senarai model akan difetch secara dinamik daripada provider yang dipilih.',
'config_ai_chatbot_base_url' => 'Provider base URL',
'config_ai_chatbot_api_key' => 'API key',
'config_ai_chatbot_api_key_keep' => 'API key telah diset. Biarkan kosong untuk kekalkan nilai semasa.',
'config_ai_chatbot_api_key_enter' => 'Masukkan API key jika provider memerlukan key.',
'config_ai_chatbot_timeout_seconds' => 'Timeout saat',
'config_ai_chatbot_max_input_chars' => 'Maksimum aksara input',
'config_ai_chatbot_max_output_tokens' => 'Maksimum token output',
'config_ai_chatbot_rate_per_minute' => 'Kadar per minit',
'config_ai_chatbot_user_daily_limit' => 'Had harian pengguna',
'config_ai_chatbot_global_daily_limit' => 'Had harian global',
'config_ai_chatbot_character_name' => 'Nama karakter',
'config_ai_chatbot_avatar_path' => 'Laluan avatar',
'config_ai_chatbot_welcome_message' => 'Mesej alu-aluan',
'config_ai_chatbot_persist_usage' => 'Simpan penggunaan',
'config_ai_chatbot_store_conversations' => 'Simpan perbualan',
'config_ai_chatbot_log_message_content' => 'Log kandungan mesej',
'config_ai_chatbot_app_url' => 'URL aplikasi',
'config_ai_chatbot_app_title' => 'Tajuk aplikasi',
'config_ai_chatbot_storage_note' => 'Semua tetapan AI Chatbot disimpan dalam tbl_m_config group ai_chatbot.',
'config_ai_chatbot_save_settings' => 'Simpan Tetapan AI Chatbot',
'config_ai_chatbot_model_fetch_failed' => 'Gagal fetch senarai model. HTTP %s',
'config_ai_chatbot_project_context_tab' => 'Project Context',
'config_ai_chatbot_project_context_title' => 'Project-Aware Data Context',
'config_ai_chatbot_project_context_subtitle' => 'Diagnostik padanan provider berdasarkan system.name.',
'config_ai_chatbot_project_status_matched' => 'Matched',
'config_ai_chatbot_project_status_core_only' => 'Core only',
'config_ai_chatbot_project_status_no_provider' => 'Tiada project provider',
'config_ai_chatbot_project_status_ambiguous' => 'Ambiguous',
'config_ai_chatbot_project_status_error' => 'Ralat',
'config_ai_chatbot_project_system_name' => 'Nama sistem',
'config_ai_chatbot_project_normalized_identity' => 'Identiti normalisasi',
'config_ai_chatbot_project_provider' => 'Provider dipadankan',
'config_ai_chatbot_project_none' => 'Tiada',
'config_ai_chatbot_project_matched_alias' => 'Alias dipadankan',
'config_ai_chatbot_project_match_score' => 'Skor padanan',
'config_ai_chatbot_project_minimum' => 'Minimum',
'config_ai_chatbot_project_provider_code' => 'Kod provider',
'config_ai_chatbot_project_provider_label' => 'Label provider',
'config_ai_chatbot_project_score' => 'Skor',
'config_ai_chatbot_project_alias' => 'Alias',
'config_ai_chatbot_project_status' => 'Status',
'config_ai_chatbot_project_no_providers' => 'Belum ada project provider didaftarkan.',
'config_ai_chatbot_project_context_note' => 'Jika nama sistem berubah dan tiada provider dipadankan, chatbot hanya akan guna core context dan knowledge base.',
'aiChatbotKnowledge_page_title' => 'AI Chatbot Knowledge Manager',
'aiChatbotKnowledge_permission_denied' => 'Anda tidak mempunyai kebenaran untuk mengurus AI Chatbot knowledge.',
...
'aiChatbotKnowledge_modal_subtitle' => 'Curated context mengikut visibility dan group.',
...
'aiChatbotKnowledge_allowed_groups_help' => 'Wajib jika visibility ialah selected groups.',
'aiChatbotKnowledge_source_review_title' => 'Source & Review',
'aiChatbotKnowledge_source_review_help' => 'Guna metadata ini untuk rujukan polisi, versi, dan tarikh semakan.',
...
'aiChatbotKnowledge_pdf_upload_help' => 'PDF sahaja. Saiz maksimum ikut Tetapan Sistem: %s MB.',
'aiChatbotKnowledge_pdf_file_label' => 'PDF file',
'aiChatbotKnowledge_pdf_note' => 'PDF akan disimpan sebagai draft source. Sistem akan cuba extract text dan jana chunk draft selepas upload.',
'aiChatbotKnowledge_pdf_source_missing' => 'Table PDF source belum tersedia. Sila pastikan migration schema PDF sudah dijalankan.',
'aiChatbotKnowledge_pdf_chunk_missing' => 'Table PDF chunk belum tersedia. Upload dan extraction boleh berjalan, tetapi chunk tidak akan dijana.',
'aiChatbotKnowledge_uploaded_pdf_title' => 'Uploaded PDF Sources',
'aiChatbotKnowledge_uploaded_pdf_help' => 'Text yang berjaya diekstrak disimpan sebagai sidecar .txt; chunk hanya digunakan oleh chatbot selepas PDF source diaktifkan.',
'aiChatbotKnowledge_no_pdf_source' => 'Tiada PDF source dimuat naik.',
'aiChatbotKnowledge_footer_note' => 'Content hanya digunakan selepas status dan visibility membenarkan retrieval.',
...
'aiChatbotKnowledge_registry_subtitle' => 'Active items sahaja dihantar kepada provider selepas filter language dan visibility.',
...
'aiChatbotKnowledge_swal_success_title' => 'Berjaya',
'aiChatbotKnowledge_swal_error_title' => 'Tidak berjaya',
'aiChatbotKnowledge_swal_close' => 'Close',
'aiChatbotKnowledge_delete_confirm_title' => 'Padam knowledge item?',
'aiChatbotKnowledge_delete_confirm_text' => 'Tindakan ini tidak boleh dibatalkan.',
...
'aiChatbotKnowledge_error_reload_table' => 'Gagal memuat semula datatable.',
'aiChatbotKnowledge_error_update_table' => 'Datatable tidak dapat dikemas kini.',
'aiChatbotKnowledge_error_action_failed' => 'Tindakan tidak berjaya diproses.',
'aiChatbotKnowledge_error_open_failed' => 'Knowledge item tidak dapat dibuka.',
'aiChatbotKnowledge_error_save_failed' => 'Knowledge item tidak berjaya disimpan.',
'aiChatbotKnowledge_error_pdf_failed' => 'PDF source tidak berjaya diproses.',
'aiChatbotKnowledge_success_action' => 'Tindakan berjaya diproses.',
'aiChatbotKnowledge_success_save' => 'Knowledge item berjaya disimpan.',
'aiChatbotKnowledge_success_pdf' => 'PDF source berjaya diproses.',
'aiChatbotKnowledge_search_placeholder' => 'Search knowledge...',
'aiChatbotReview_page_title' => 'AI Chatbot Review Dashboard',
'aiChatbotReview_permission_denied' => 'Anda tidak mempunyai kebenaran untuk melihat AI Chatbot Review Dashboard.',
